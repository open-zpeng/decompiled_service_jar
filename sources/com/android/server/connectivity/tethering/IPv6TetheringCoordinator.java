...
public class IPv6TetheringCoordinator {
    ...
    private void updateIPv6TetheringInterfaces() {
        ...
        if (it.hasNext()) {
            IpServer ipServer = it.next();
            LinkProperties lp = getInterfaceIPv6LinkProperties(ipServer);
    ...
    private static String toDebugString(NetworkState ns) {
        return ns == null ? "NetworkState{null}" : String.format("NetworkState{%s, %s, %s}", ns.network, ns.networkCapabilities, ns.linkProperties);
    }
