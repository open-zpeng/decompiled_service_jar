...
public class TcpKeepaliveController {
    ...
    public static TcpKeepalivePacketData getTcpKeepalivePacket(FileDescriptor fd) throws SocketKeepalive.InvalidPacketException, SocketKeepalive.InvalidSocketException {
        try {
            TcpKeepalivePacketDataParcelable tcpDetails = switchToRepairMode(fd);
    ...
    public void startSocketMonitor(FileDescriptor fd, final KeepaliveTracker.KeepaliveInfo ki, int slot) throws IllegalArgumentException, SocketKeepalive.InvalidSocketException {
        synchronized (this.mListeners) {
            ...
            this.mFdHandlerQueue.addOnFileDescriptorEventListener(fd, 5, new MessageQueue.OnFileDescriptorEventListener() { // from class: com.android.server.connectivity.-$$Lambda$TcpKeepaliveController$mLZJWrEAOnfgV5N3ZSa2J3iTmxE
                @Override // android.os.MessageQueue.OnFileDescriptorEventListener
                public final int onFileDescriptorEvents(FileDescriptor fileDescriptor, int i2) {
                    return TcpKeepaliveController.lambda$startSocketMonitor$0(KeepaliveTracker.KeepaliveInfo.this, fileDescriptor, i2);
                }
            });
    ...
    public static /* synthetic */ int lambda$startSocketMonitor$0(KeepaliveTracker.KeepaliveInfo ki, FileDescriptor readyFd, int events) {
        int reason;
        if ((events & 4) != 0) {
            reason = -25;
        } else {
