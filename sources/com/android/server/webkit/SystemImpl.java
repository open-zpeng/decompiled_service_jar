...
public class SystemImpl implements SystemInterface {
    ...
    public void updateUserSetting(Context context, String newProviderName) {
        Settings.Global.putString(context.getContentResolver(), "webview_provider", newProviderName == null ? BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS : newProviderName);
    }
    ...
    public void uninstallAndDisablePackageForAllUsers(final Context context, String packageName) {
        ...
        try {
            ...
            if (applicationInfo != null && applicationInfo.isUpdatedSystemApp()) {
                pm.deletePackage(packageName, new IPackageDeleteObserver.Stub() { // from class: com.android.server.webkit.SystemImpl.1
