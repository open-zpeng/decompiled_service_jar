...
public class TextServicesManagerService extends ITextServicesManager.Stub {
    ...
    @GuardedBy({"mLock"})
    private final LazyIntToIntMap mSpellCheckerOwnerUserIdMap = new LazyIntToIntMap(new IntUnaryOperator() { // from class: com.android.server.textservices.-$$Lambda$TextServicesManagerService$otJ1a5fe5mYJvLrIEr3o1Ia1kSo
    ...
    public SpellCheckerInfo getCurrentSpellCheckerForUser(int userId) {
        ...
        synchronized (this.mLock) {
            int spellCheckerOwnerUserId = this.mSpellCheckerOwnerUserIdMap.get(userId);
    ...
    private TextServicesData getDataFromCallingUserIdLocked(int callingUserId) {
        ...
        TextServicesData data = this.mUserData.get(spellCheckerOwnerUserId);
        if (!InputMethodSystemProperty.PER_PROFILE_IME_ENABLED && spellCheckerOwnerUserId != callingUserId) {
    ...
    public final class SpellCheckerBindGroup {
        ...
        public void removeListener(ISpellCheckerSessionListener listener) {
            synchronized (TextServicesManagerService.this.mLock) {
                ...
                Predicate<SessionRequest> removeCondition = new Predicate() { // from class: com.android.server.textservices.-$$Lambda$TextServicesManagerService$SpellCheckerBindGroup$H2umvFNjpgILSC1ZJmUoLxzCdSk
