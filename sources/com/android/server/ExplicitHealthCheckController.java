...
public class ExplicitHealthCheckController {
    ...
    public void initState(IBinder service) {
        synchronized (this.mLock) {
            ...
            try {
                this.mRemoteService.setCallback(new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: com.android.server.-$$Lambda$ExplicitHealthCheckController$6YGiVtgCnlJ0hMIeX5TzlFUaNrY
                    public final void onResult(Bundle bundle) {
