    ...
    public static class SliceAuthority implements DirtyTracker.Persistable {
        ...
        public boolean equals(Object obj) {
            if (getClass().equals(obj != null ? obj.getClass() : null)) {
                ...
                p1.sort(Comparator.comparing(new Function() { // from class: com.android.server.slice.-$$Lambda$SliceClientPermissions$SliceAuthority$gfIfSC_15op1dWInvxEKC7DlOkg
                ...
                p2.sort(Comparator.comparing(new Function() { // from class: com.android.server.slice.-$$Lambda$SliceClientPermissions$SliceAuthority$czFcrdPWpaFU7_jx7xCl0wMHBps
                    @Override // java.util.function.Function
                    public final Object apply(Object obj2) {
                        String join;
                        join = TextUtils.join(",", (String[]) obj2);
        ...
        private String pathToString(ArraySet<String[]> paths) {
            return TextUtils.join(", ", (Iterable) paths.stream().map(new Function() { // from class: com.android.server.slice.-$$Lambda$SliceClientPermissions$SliceAuthority$lvjy01xuWTQLCsbGw02qqI7DYDM
                @Override // java.util.function.Function
