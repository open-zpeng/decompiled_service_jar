...
public class ValidateNotificationPeople implements NotificationSignalExtractor {
    ...
    /* JADX WARN: Removed duplicated region for block: B:29:0x0093 A[Catch: all -> 0x00a8, TryCatch #0 {, blocks: (B:19:0x0068, B:21:0x007a, B:24:0x0081, B:26:0x0085, B:29:0x0093, B:30:0x009d, B:31:0x009e, B:27:0x008e), top: B:50:0x0068 }] */
    /*
    ...
    */
    ...
    private static String[] getExtraPeopleForKey(Bundle extras, String key) {
        ...
        if (people instanceof ArrayList) {
            ...
            if (arrayList.get(0) instanceof CharSequence) {
                ...
                while (i < N2) {
                    array2[i] = ((Person) arrayList.get(i)).resolveToLegacyUri();
                    i++;
                }
                return array2;
            } else {
            ...
            if (people instanceof CharSequence[]) {
                ...
                while (i < N3) {
                    array3[i] = charSeqArray[i].toString();
                    i++;
                }
                return array3;
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public com.android.server.notification.ValidateNotificationPeople.LookupResult searchContacts(android.content.Context r9, android.net.Uri r10) {
        /*
            r8 = this;
            com.android.server.notification.ValidateNotificationPeople$LookupResult r0 = new com.android.server.notification.ValidateNotificationPeople$LookupResult
            r0.<init>()
            r1 = 0
            android.content.ContentResolver r2 = r9.getContentResolver()     // Catch: java.lang.Throwable -> L37
            java.lang.String[] r4 = com.android.server.notification.ValidateNotificationPeople.LOOKUP_PROJECTION     // Catch: java.lang.Throwable -> L37
            r5 = 0
            r6 = 0
            r7 = 0
            r3 = r10
            android.database.Cursor r2 = r2.query(r3, r4, r5, r6, r7)     // Catch: java.lang.Throwable -> L37
            r1 = r2
            if (r1 != 0) goto L25
            java.lang.String r2 = "ValidateNoPeople"
            java.lang.String r3 = "Null cursor from contacts query."
            android.util.Slog.w(r2, r3)     // Catch: java.lang.Throwable -> L37
            if (r1 == 0) goto L24
            r1.close()
        L24:
            return r0
        L25:
            ...
            if (r2 == 0) goto L2f
            r0.mergeContact(r1)     // Catch: java.lang.Throwable -> L37
            goto L25
        L2f:
            if (r1 == 0) goto L42
        L31:
        ...
        L37:
            ...
            android.util.Slog.w(r3, r4, r2)     // Catch: java.lang.Throwable -> L35
            if (r1 == 0) goto L42
            goto L31
        L42:
            return r0
