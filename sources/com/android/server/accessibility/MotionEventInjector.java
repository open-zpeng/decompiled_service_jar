...
public class MotionEventInjector extends BaseEventStreamTransformation implements Handler.Callback {
        ...
        if (motionEventInjector.mIsDestroyed) {
            ...
            if (!events.isEmpty()) {
                ...
                while (i < events.size()) {
                    ...
                    Message message = motionEventInjector.mHandler.obtainMessage(1, isEndOfSequence, 0, event);
    ...
    private boolean prepareToContinueOldGesture(List<GestureDescription.GestureStep> gestureSteps) {
        ...
        for (int numContinuedStrokes2 = 0; numContinuedStrokes2 < firstStep.numTouchPoints; numContinuedStrokes2++) {
            GestureDescription.TouchPoint touchPoint = firstStep.touchPoints[numContinuedStrokes2];
        ...
        for (int i = 0; i < this.mNumLastTouchPoints; i++) {
    ...
    private void appendUpEvents(List<MotionEvent> motionEvents, GestureDescription.TouchPoint[] currentTouchPoints, int currentTouchPointsSize, long currentTime) {
        ...
        while (true) {
            ...
            if (currentTouchPoints[i2].mIsEndOfPath && (indexOfUpEvent = findPointByStrokeId(lastTouchPoints, this.mNumLastTouchPoints, currentTouchPoints[i2].mStrokeId)) >= 0) {
