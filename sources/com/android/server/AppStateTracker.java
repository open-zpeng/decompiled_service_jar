...
public class AppStateTracker {
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            Listener[] cloneListeners2;
            Listener[] cloneListeners3;
            Listener[] cloneListeners4;
            Listener[] cloneListeners5;
            Listener[] cloneListeners6;
            Listener[] cloneListeners7;
            Listener[] cloneListeners8;
            Listener[] cloneListeners9;
            if (msg.what != 8) {
                synchronized (AppStateTracker.this.mLock) {
                    if (AppStateTracker.this.mStarted) {
                        ...
                        switch (msg.what) {
                            ...
                            case 9:
                                ...
                                for (Listener l8 : AppStateTracker.this.cloneListeners()) {
                                    l8.updateAllJobs();
                                    if (unblockAlarms) {
                                ...
                                return;
                            case 10:
                                for (Listener l9 : AppStateTracker.this.cloneListeners()) {
    ...
    static boolean isAnyAppIdUnwhitelisted(int[] prevArray, int[] newArray) {
        ...
        while (true) {
            ...
            newFinished = i12 >= newArray.length;
