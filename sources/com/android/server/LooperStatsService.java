...
public class LooperStatsService extends Binder {
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, pw)) {
            ...
            entries.sort(Comparator.comparing(new Function() { // from class: com.android.server.-$$Lambda$LooperStatsService$Byo6QAxZpVXDCMtjrcYJc6YLAks
            ...
            }).thenComparing(new Function() { // from class: com.android.server.-$$Lambda$LooperStatsService$Vzysuo2tO86qjfcWeh1Rdb47NQQ
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    String str;
            ...
            }).thenComparing(new Function() { // from class: com.android.server.-$$Lambda$LooperStatsService$XjYmSR91xdWG1Xgt-Gj9GBZZbjk
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    String str;
            ...
            }).thenComparing(new Function() { // from class: com.android.server.-$$Lambda$LooperStatsService$XtFJEDeyYRT79ZkVP96XkHribxg
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    String str;
    ...
    private class LooperShellCommand extends ShellCommand {
        ...
        public int onCommand(String cmd) {
            if (xpInputManagerService.InputPolicyKey.KEY_ENABLE.equals(cmd)) {
