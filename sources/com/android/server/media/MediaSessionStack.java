...
public class MediaSessionStack {
    ...
    public void onPlaystateChanged(MediaSessionRecord record, int oldState, int newState) {
        ...
        if (this.mMediaButtonSession != null && this.mMediaButtonSession.getUid() == record.getUid() && (newMediaButtonSession = findMediaButtonSession(this.mMediaButtonSession.getUid())) != this.mMediaButtonSession) {
