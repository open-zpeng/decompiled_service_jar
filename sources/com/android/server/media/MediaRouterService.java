    ...
    private void registerClientLocked(IMediaRouterClient client, int uid, int pid, String packageName, int userId, boolean trusted) {
        ...
        if (this.mAllClientRecords.get(binder) == null) {
            ...
            try {
                ...
                if (newUser2) {
                    this.mUserRecords.put(userId, userRecord2);
            ...
            synchronized (this.mService.mLock) {
                try {
                    try {
                        ...
                        int routeTypes = 0;
                        for (int routeTypes2 = 0; routeTypes2 < count; routeTypes2++) {
                            ClientRecord clientRecord = this.mUserRecord.mClientRecords.get(routeTypes2);
