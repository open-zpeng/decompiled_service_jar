...
public class PersistentPreferredActivity extends IntentFilter {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public PersistentPreferredActivity(IntentFilter filter, ComponentName activity) {
        super(filter);
        this.mComponent = activity;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public PersistentPreferredActivity(XmlPullParser parser) throws XmlPullParserException, IOException {
