...
public final class InstantAppResolverConnection implements IBinder.DeathRecipient {
    ...
    public final List<InstantAppResolveInfo> getInstantAppResolveInfoList(Intent sanitizedIntent, int[] hashPrefix, String token) throws ConnectionException {
        ...
        try {
            try {
                try {
                    IInstantAppResolver target = getRemoteInstanceLazy(token);
                    try {
                        List<InstantAppResolveInfo> instantAppResolveInfoList = this.mGetInstantAppResolveInfoCaller.getInstantAppResolveInfoList(target, sanitizedIntent, hashPrefix, token);
    ...
    public final void getInstantAppIntentFilterList(Intent sanitizedIntent, int[] hashPrefix, String token, PhaseTwoCallback callback, Handler callbackHandler, long startTime) throws ConnectionException {
        try {
            getRemoteInstanceLazy(token).getInstantAppIntentFilterList(sanitizedIntent, hashPrefix, token, new AnonymousClass1(callbackHandler, callback, startTime));
        } catch (RemoteException e) {
