...
public class ArtManagerService extends IArtManager.Stub {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:39:? -> B:32:0x00b1). Please submit an issue!!! */
    ...
    public boolean compileLayouts(PackageParser.Package pkg) {
        ...
        try {
            ...
            if (!appInfo.isPrivilegedApp() && !appInfo.isEmbeddedDexUsed() && !appInfo.isDefaultToDeviceProtectedStorage()) {
