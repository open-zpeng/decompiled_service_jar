    ...
    public static List<PackageParser.Package> getPackagesForDexopt(Collection<PackageParser.Package> packages, PackageManagerService packageManagerService) {
        ...
        if (!remainingPkgs.isEmpty() && packageManagerService.isHistoricalPackageUsageAvailable()) {
            ...
            if (estimatedPreviousSystemUseTime != 0) {
                ...
                Predicate<PackageParser.Package> remainingPredicate3 = new Predicate() { // from class: com.android.server.pm.-$$Lambda$PackageManagerServiceUtils$p5q19y4-2x-i747j_hTNL1EMzt0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return PackageManagerServiceUtils.lambda$getPackagesForDexopt$5(cutoffTime, (PackageParser.Package) obj);
                    }
                };
                remainingPredicate2 = remainingPredicate3;
            } else {
                Predicate<PackageParser.Package> remainingPredicate4 = new Predicate() { // from class: com.android.server.pm.-$$Lambda$PackageManagerServiceUtils$Fz3elZ0VmMMv9-wl_G3AN15dUU8
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return PackageManagerServiceUtils.lambda$getPackagesForDexopt$6((PackageParser.Package) obj);
                    }
                };
                remainingPredicate2 = remainingPredicate4;
            }
