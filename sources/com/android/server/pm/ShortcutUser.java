...
public class ShortcutUser {
    ...
    */
    public static com.android.server.pm.ShortcutUser loadFromXml(com.android.server.pm.ShortcutService r17, org.xmlpull.v1.XmlPullParser r18, int r19, boolean r20) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException, com.android.server.pm.ShortcutService.InvalidFileFormatException {
        /*
            r1 = r17
            r2 = r18
            r3 = r19
            ...
            java.lang.String r0 = com.android.server.pm.ShortcutService.parseStringAttribute(r2, r0)     // Catch: java.lang.RuntimeException -> Lc5
            r5.mKnownLocales = r0     // Catch: java.lang.RuntimeException -> Lc5
            java.lang.String r0 = "last-app-scan-time2"
            long r6 = com.android.server.pm.ShortcutService.parseLongAttribute(r2, r0)     // Catch: java.lang.RuntimeException -> Lc5
            long r8 = r17.injectCurrentTimeMillis()     // Catch: java.lang.RuntimeException -> Lc5
        ...
        L28:
            r10 = 0
        L2a:
            r5.mLastAppScanTime = r10     // Catch: java.lang.RuntimeException -> Lc5
            java.lang.String r0 = "last-app-scan-fp"
            java.lang.String r0 = com.android.server.pm.ShortcutService.parseStringAttribute(r2, r0)     // Catch: java.lang.RuntimeException -> Lc5
            r5.mLastAppScanOsFingerprint = r0     // Catch: java.lang.RuntimeException -> Lc5
            java.lang.String r0 = "restore-from-fp"
            java.lang.String r0 = com.android.server.pm.ShortcutService.parseStringAttribute(r2, r0)     // Catch: java.lang.RuntimeException -> Lc5
            r5.mRestoreFromOsFingerprint = r0     // Catch: java.lang.RuntimeException -> Lc5
            int r0 = r18.getDepth()     // Catch: java.lang.RuntimeException -> Lc5
        L42:
            int r10 = r18.next()     // Catch: java.lang.RuntimeException -> Lc5
            r11 = r10
            r12 = 1
            if (r10 == r12) goto Lc3
            r10 = 3
            if (r11 != r10) goto L53
            int r10 = r18.getDepth()     // Catch: java.lang.RuntimeException -> Lc5
            if (r10 <= r0) goto Lc3
        L53:
            r10 = 2
            if (r11 == r10) goto L57
            goto L42
        L57:
            int r13 = r18.getDepth()     // Catch: java.lang.RuntimeException -> Lc5
            java.lang.String r14 = r18.getName()     // Catch: java.lang.RuntimeException -> Lc5
            int r15 = r0 + 1
            if (r13 != r15) goto Lbf
            r15 = -1
            int r10 = r14.hashCode()     // Catch: java.lang.RuntimeException -> Lc5
            r12 = -1407250528(0xffffffffac1f0fa0, float:-2.2603933E-12)
            if (r10 == r12) goto L8e
            r12 = -1146595445(0xffffffffbba8578b, float:-0.005137389)
            if (r10 == r12) goto L83
            r12 = -807062458(0xffffffffcfe53446, float:-7.6908165E9)
            if (r10 == r12) goto L78
            goto L99
        L78:
            java.lang.String r10 = "package"
            boolean r10 = r14.equals(r10)     // Catch: java.lang.RuntimeException -> Lc5
            if (r10 == 0) goto L99
            r12 = 1
            goto L9a
        L83:
        ...
        L9a:
            switch(r12) {
                ...
                case 2: goto L9e;
                default: goto L9d;
            }     // Catch: java.lang.RuntimeException -> Lc5
        L9d:
            goto Lbf
        L9e:
            com.android.server.pm.ShortcutLauncher r10 = com.android.server.pm.ShortcutLauncher.loadFromXml(r2, r5, r3, r4)     // Catch: java.lang.RuntimeException -> Lc5
            r5.addLauncher(r10)     // Catch: java.lang.RuntimeException -> Lc5
            goto L42
        La7:
            com.android.server.pm.ShortcutPackage r10 = com.android.server.pm.ShortcutPackage.loadFromXml(r1, r5, r2, r4)     // Catch: java.lang.RuntimeException -> Lc5
            android.util.ArrayMap<java.lang.String, com.android.server.pm.ShortcutPackage> r12 = r5.mPackages     // Catch: java.lang.RuntimeException -> Lc5
            java.lang.String r15 = r10.getPackageName()     // Catch: java.lang.RuntimeException -> Lc5
            r12.put(r15, r10)     // Catch: java.lang.RuntimeException -> Lc5
            goto L42
        Lb5:
            java.lang.String r10 = "value"
            android.content.ComponentName r10 = com.android.server.pm.ShortcutService.parseComponentNameAttribute(r2, r10)     // Catch: java.lang.RuntimeException -> Lc5
            r5.mLastKnownLauncher = r10     // Catch: java.lang.RuntimeException -> Lc5
            goto L42
        Lbf:
            com.android.server.pm.ShortcutService.warnForInvalidTag(r13, r14)     // Catch: java.lang.RuntimeException -> Lc5
            goto L42
        Lc3:
            return r5
        Lc5:
    ...
    public void mergeRestoredFile(ShortcutUser restored) {
        ...
        restored.forAllLaunchers(new Consumer() { // from class: com.android.server.pm.-$$Lambda$ShortcutUser$zwhAnw7NjAOfNphKSeWurjAD6OM
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ShortcutUser.lambda$mergeRestoredFile$3(ShortcutUser.this, s, restoredLaunchers, (ShortcutLauncher) obj);
            }
        });
        restored.forAllPackages(new Consumer() { // from class: com.android.server.pm.-$$Lambda$ShortcutUser$078_3k15h1rTyJTkYAHYqf5ltYg
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ShortcutUser.lambda$mergeRestoredFile$4(ShortcutUser.this, s, restoredPackages, restoredShortcuts, (ShortcutPackage) obj);
            }
        });
