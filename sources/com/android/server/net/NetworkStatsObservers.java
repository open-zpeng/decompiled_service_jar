...
public class NetworkStatsObservers {
    ...
    private Handler.Callback mHandlerCallback = new Handler.Callback() { // from class: com.android.server.net.NetworkStatsObservers.1
    ...
    public void updateStats(NetworkStats xtSnapshot, NetworkStats uidSnapshot, ArrayMap<String, NetworkIdentitySet> activeIfaces, ArrayMap<String, NetworkIdentitySet> activeUidIfaces, long currentTime) {
        StatsContext statsContext = new StatsContext(xtSnapshot, uidSnapshot, activeIfaces, activeUidIfaces, currentTime);
    ...
    public static class NetworkUsageRequestInfo extends RequestInfo {
        ...
        protected void recordSample(StatsContext statsContext) {
            this.mRecorder.recordSnapshotLocked(statsContext.mXtSnapshot, statsContext.mActiveIfaces, statsContext.mCurrentTime);
        }
    ...
    public static class UserUsageRequestInfo extends RequestInfo {
        ...
        @Override // com.android.server.net.NetworkStatsObservers.RequestInfo
        protected void recordSample(StatsContext statsContext) {
            this.mRecorder.recordSnapshotLocked(statsContext.mUidSnapshot, statsContext.mActiveUidIfaces, statsContext.mCurrentTime);
        }

        private long getTotalBytesForNetworkUid(NetworkTemplate template, int uid) {
            try {
                NetworkStatsHistory history = this.mCollection.getHistory(template, null, uid, -1, 0, -1, Long.MIN_VALUE, JobStatus.NO_LATEST_RUNTIME, this.mAccessLevel, this.mCallingUid);
    ...
    public static class StatsContext {
        ...
        StatsContext(NetworkStats xtSnapshot, NetworkStats uidSnapshot, ArrayMap<String, NetworkIdentitySet> activeIfaces, ArrayMap<String, NetworkIdentitySet> activeUidIfaces, long currentTime) {
