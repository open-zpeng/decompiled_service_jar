...
public class GnssConfiguration {
    ...
    /* renamed from: com.android.server.location.GnssConfiguration$1  reason: invalid class name */
    /* loaded from: classes.dex */
    class AnonymousClass1 extends HashMap<String, SetCarrierProperty> {
        ...
        AnonymousClass1(HalInterfaceVersion halInterfaceVersion) {
            ...
            put(GnssConfiguration.CONFIG_SUPL_VER, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$9cfNUAWKKutp5KSqhvHSGJNe0ao
            ...
            put(GnssConfiguration.CONFIG_SUPL_MODE, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$384RrX20Mx6OJsRiqsQcSxYdcZc
                @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                public final boolean set(int i) {
            ...
            if (GnssConfiguration.isConfigSuplEsSupported(this.val$gnssConfigurationIfaceVersion)) {
                put(GnssConfiguration.CONFIG_SUPL_ES, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$sKzdHBM7V7DxdhcWx1u8hipJYFo
                    @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                    public final boolean set(int i) {
            ...
            put(GnssConfiguration.CONFIG_LPP_PROFILE, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$5tBf0Ru8L994vqKbXOeOBj2A-CA
                @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                public final boolean set(int i) {
            ...
            put(GnssConfiguration.CONFIG_A_GLONASS_POS_PROTOCOL_SELECT, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$aaV8BigB_1Oil1H82EHUb0zvWPo
                @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                public final boolean set(int i) {
            ...
            put(GnssConfiguration.CONFIG_USE_EMERGENCY_PDN_FOR_EMERGENCY_SUPL, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$8lp2ukEzg_Agf73p3ka-dqhWUpE
                @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                public final boolean set(int i) {
            ...
            if (GnssConfiguration.isConfigGpsLockSupported(this.val$gnssConfigurationIfaceVersion)) {
                put(GnssConfiguration.CONFIG_GPS_LOCK, new SetCarrierProperty() { // from class: com.android.server.location.-$$Lambda$GnssConfiguration$1$rRu0NBMB8DgPt3DY5__6u_WNl7A
                    @Override // com.android.server.location.GnssConfiguration.SetCarrierProperty
                    public final boolean set(int i) {
