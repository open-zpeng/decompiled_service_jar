...
public final class InputMethodUtils {
    ...
    public static void setNonSelectedSystemImesDisabledUntilUsed(IPackageManager packageManager, List<InputMethodInfo> enabledImis, int userId, String callingPackage) {
        String[] systemImesDisabledUntilUsed = Resources.getSystem().getStringArray(17236012);
    ...
    public static int[] resolveUserId(int userIdToBeResolved, int currentUserId, PrintWriter warningWriter) {
        ...
        int resolvedUserId = InputMethodSystemProperty.PER_PROFILE_IME_ENABLED ? sourceUserId : userManagerInternal.getProfileParentId(sourceUserId);
