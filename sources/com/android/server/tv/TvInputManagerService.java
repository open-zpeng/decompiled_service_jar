    ...
    */
    public void releaseSessionLocked(android.os.IBinder r6, int r7, int r8) {
        /*
            ...
            r0 = 0
            r1 = r0
            com.android.server.tv.TvInputManagerService$SessionState r2 = r5.getSessionStateLocked(r6, r7, r8)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
            r1 = r2
            android.media.tv.ITvInputSession r2 = com.android.server.tv.TvInputManagerService.SessionState.access$1700(r1)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
            if (r2 == 0) goto L22
            com.android.server.tv.TvInputManagerService$UserState r2 = r5.getOrCreateUserStateLocked(r8)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
            android.os.IBinder r3 = com.android.server.tv.TvInputManagerService.UserState.access$3000(r2)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
            if (r6 != r3) goto L1b
            r3 = 0
            r5.setMainLocked(r6, r3, r7, r8)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
        L1b:
            android.media.tv.ITvInputSession r3 = com.android.server.tv.TvInputManagerService.SessionState.access$1700(r1)     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
            r3.release()     // Catch: java.lang.Throwable -> L28 java.lang.Throwable -> L2a
        L22:
            if (r1 == 0) goto L35
        L24:
            com.android.server.tv.TvInputManagerService.SessionState.access$1702(r1, r0)
            goto L35
        L28:
            r2 = move-exception
            goto L39
        L2a:
            ...
            android.util.Slog.e(r3, r4, r2)     // Catch: java.lang.Throwable -> L28
            if (r1 == 0) goto L35
            goto L24
        L35:
        ...
        public void registerCallback(final ITvInputManagerCallback callback, int userId) {
            ...
            try {
                synchronized (TvInputManagerService.this.mLock) {
                    ...
                    try {
                        callback.asBinder().linkToDeath(new IBinder.DeathRecipient() { // from class: com.android.server.tv.TvInputManagerService.BinderService.1
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (serviceState2.service != null) {
                                    try {
                                        TvInputManagerService.this.createSessionInternalLocked(serviceState2.service, binder, resolvedUserId);
                                    } catch (Throwable th) {
                                        th = th;
                                        identity = identity2;
                                        while (true) {
            ...
            try {
                synchronized (TvInputManagerService.this.mLock) {
                    try {
                        ...
                        try {
                            return TvInputManagerService.this.mTvInputHardwareManager.captureFrame(hardwareInputId2 != null ? hardwareInputId2 : inputId, surface, config, callingUid, resolvedUserId);
                        } catch (Throwable th) {
                            th = th;
                            throw th;
                        }
                    ...
                    for (int i2 = 0; i2 < TvInputManagerService.this.mUserStates.size(); i2++) {
                        ...
                        for (Map.Entry<IBinder, ClientState> entry2 : userState.clientStateMap.entrySet()) {
                            ...
                            for (IBinder token : client.sessionTokens) {
                                pw.println(BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + token);
                            }
                            pw.decreaseIndent();
                        ...
                        for (Map.Entry<ComponentName, ServiceState> entry3 : userState.serviceStateMap.entrySet()) {
                            ...
                            for (IBinder token2 : service.sessionTokens) {
                                pw.println(BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + token2);
                            }
                            pw.decreaseIndent();
