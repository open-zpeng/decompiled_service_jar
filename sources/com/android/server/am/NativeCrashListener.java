...
public final class NativeCrashListener extends Thread {
    ...
    public class NativeCrashReporter extends Thread {
        ...
        NativeCrashReporter(int pid, int signal, String report) {
            super("NativeCrashReport");
            this.mPid = pid;
            this.mSignal = signal;
            this.mCrashReport = report;
        ...
        public void run() {
            try {
                ...
                if (this.mApp != null) {
                    ...
                    ci.exceptionClassName = "Native process crash";
                }
                ...
                if (this.mApp != null) {
                    ...
                    NativeCrashListener.this.mAm.handleNativeCrashInner(this.mPid, "native_process_crash", ci);
                }
            } catch (Exception e) {
    ...
    void consumeNativeCrashData(FileDescriptor fd) {
        ...
        try {
            ...
            if (pid > 0) {
                ...
                Slog.w(TAG, "this is native process: " + pid);
                new NativeCrashReporter(pid, signal, reportString).start();
                return;
            }
