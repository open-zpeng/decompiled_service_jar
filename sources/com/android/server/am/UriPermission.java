...
public final class UriPermission {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public UriPermission(String sourcePkg, String targetPkg, int targetUid, ActivityManagerService.GrantUri uri) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void grantModes(int modeFlags, UriPermissionOwner owner) {
