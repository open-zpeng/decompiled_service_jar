...
public final class ProcessRecord {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setStartParams(int startUid, String hostingType, String hostingNameStr, String seInfo, long startTime) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ProcessRecord(ActivityManagerService _service, BatteryStatsImpl _batteryStats, ApplicationInfo _info, String _processName, int _uid) {
    ...
    public boolean isInterestingToUserLocked() {
        ...
        for (int i2 = 0; i2 < servicesSize; i2++) {
            ServiceRecord r2 = this.services.valueAt(i2);
            if (r2.isForeground) {
                return true;
            }
        }
