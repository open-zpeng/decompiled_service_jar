...
public final class ReceiverList extends ArrayList<BroadcastFilter> implements IBinder.DeathRecipient {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ReceiverList(ActivityManagerService _owner, ProcessRecord _app, int _pid, int _uid, int _userId, IIntentReceiver _receiver) {
        this.owner = _owner;
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            bf.writeToProto(proto, 2246267895815L);
        }
