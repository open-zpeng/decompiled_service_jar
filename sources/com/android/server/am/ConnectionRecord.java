...
public final class ConnectionRecord {
    private static final int[] BIND_ORIG_ENUMS = {1, 2, 4, DumpState.DUMP_VOLUMES, 8, 16, 32, 64, 128, DumpState.DUMP_APEX, 67108864, 134217728, 268435456, 536870912, 1073741824, 256, 4096};
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ConnectionRecord(AppBindRecord _binding, ActivityServiceConnectionsHolder<ConnectionRecord> _activity, IServiceConnection _conn, int _flags, int _clientLabel, PendingIntent _clientIntent, int _clientUid, String _clientProcessName, String _clientPackageName) {
