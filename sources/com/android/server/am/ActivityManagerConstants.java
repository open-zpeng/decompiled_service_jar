...
public final class ActivityManagerConstants extends ContentObserver {
    ...
    public ActivityManagerConstants(Context context, ActivityManagerService service, Handler handler) {
        ...
        this.SERVICE_USAGE_INTERACTION_TIME = 1800000L;
        ...
        this.mSystemServerAutomaticHeapDumpEnabled = (Build.IS_DEBUGGABLE && context.getResources().getBoolean(17891397)) ? false : false;
        this.mSystemServerAutomaticHeapDumpPackageName = context.getPackageName();
        this.mSystemServerAutomaticHeapDumpPssThresholdBytes = Math.max((long) MIN_AUTOMATIC_HEAP_DUMP_PSS_THRESHOLD_BYTES, context.getResources().getInteger(17694769));
    }
    ...
    private void updateConstants() {
        ...
        synchronized (this.mService) {
            try {
                ...
                this.SERVICE_USAGE_INTERACTION_TIME = this.mParser.getLong(KEY_SERVICE_USAGE_INTERACTION_TIME, 1800000L);
    ...
    public void updateMaxCachedProcesses() {
        ...
        try {
            if (this.mOverrideMaxCachedProcesses < 0) {
                i = TextUtils.isEmpty(maxCachedProcessesFlag) ? 16 : Integer.parseInt(maxCachedProcessesFlag);
            } else {
            ...
            this.CUR_MAX_CACHED_PROCESSES = 16;
        }
