...
public final class AppErrorDialog extends BaseErrorDialog implements View.OnClickListener {
    ...
    public AppErrorDialog(Context context, ActivityManagerService service, Data data) {
        ...
        if (this.mProc.pkgList.size() == 1 && (name = context.getPackageManager().getApplicationLabel(this.mProc.info)) != null) {
            setTitle(res.getString(data.repeating ? 17039454 : 17039453, bidi.unicodeWrap(name.toString()), bidi.unicodeWrap(this.mProc.info.processName)));
        } else {
            CharSequence name2 = this.mProc.processName;
            setTitle(res.getString(data.repeating ? 17039459 : 17039458, bidi.unicodeWrap(name2.toString())));
        }
        setCancelable(true);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView restart = (TextView) findViewById(16908790);
        ...
        TextView appInfo = (TextView) findViewById(16908786);
        ...
        TextView mute = (TextView) findViewById(16908788);
