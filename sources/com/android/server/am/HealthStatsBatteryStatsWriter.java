...
public class HealthStatsBatteryStatsWriter {
    ...
    public void writeProc(HealthStatsWriter procWriter, BatteryStats.Uid.Proc proc) {
        ...
        procWriter.addMeasurement((int) EventLogTags.AM_NEW_INTENT, proc.getStarts(0));
        procWriter.addMeasurement((int) EventLogTags.AM_CREATE_TASK, proc.getNumCrashes(0));
        procWriter.addMeasurement((int) EventLogTags.AM_CREATE_ACTIVITY, proc.getNumAnrs(0));
