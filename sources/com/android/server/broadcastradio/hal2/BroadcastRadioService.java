...
public class BroadcastRadioService {
    ...
    public Collection<RadioManager.ModuleProperties> listModules() {
        ...
        synchronized (this.mLock) {
            collection = (Collection) this.mModules.values().stream().map(new Function() { // from class: com.android.server.broadcastradio.hal2.-$$Lambda$BroadcastRadioService$NfRbSZZMVkp9di5eX6n4aCxsJVI
