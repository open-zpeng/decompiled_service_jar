...
public class DiskStatsService extends Binder {
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        if (DumpUtils.checkDumpAndUsageStatsPermission(this.mContext, TAG, pw)) {
            ...
            ProtoOutputStream proto4 = proto;
            PrintWriter pw4 = pw2;
            reportFreeSpace(Environment.getDataDirectory(), "Data", pw2, proto, 0);
            reportFreeSpace(Environment.getDownloadCacheDirectory(), "Cache", pw4, proto, 1);
            reportFreeSpace(new File("/system"), "System", pw4, proto, 2);
