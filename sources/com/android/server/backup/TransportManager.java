...
public class TransportManager {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public TransportManager(Context context, Set<ComponentName> whitelist, String selectedTransport) {
    ...
    public String getTransportDataManagementLabel(String transportName) throws TransportNotRegisteredException {
        String str;
        synchronized (this.mTransportLock) {
            str = getRegisteredTransportDescriptionOrThrowLocked(transportName).dataManagementLabel;
        }
        return str;
    }
