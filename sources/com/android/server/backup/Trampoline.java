...
public class Trampoline extends IBackupManager.Stub {
    ...
    public void initializeService() {
        postToHandler(new Runnable() { // from class: com.android.server.backup.-$$Lambda$Trampoline$RB5ywBeynPqhAQ6VHW4qi9U4c84
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void unlockUser(final int userId) {
        postToHandler(new Runnable() { // from class: com.android.server.backup.-$$Lambda$Trampoline$_vkvTSe7bkLYa64kIjWjqjTHe7E
            @Override // java.lang.Runnable
            public final void run() {
                Trampoline.this.lambda$unlockUser$1$Trampoline(userId);
            }
        });
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void stopUser(final int userId) {
        postToHandler(new Runnable() { // from class: com.android.server.backup.-$$Lambda$Trampoline$a6uexAeN8zHcMQQ9h_KZ71UQV_A
            @Override // java.lang.Runnable
            public final void run() {
                Trampoline.this.lambda$stopUser$2$Trampoline(userId);
            }
        });
    }
    ...
    public boolean setBackupPassword(String currentPw, String newPw) throws RemoteException {
        ...
        return isUserReadyForBackup(userId) && this.mService.setBackupPassword(currentPw, newPw);
    }

    public boolean hasBackupPassword() throws RemoteException {
        int userId = binderGetCallingUserId();
        return isUserReadyForBackup(userId) && this.mService.hasBackupPassword();
    }
