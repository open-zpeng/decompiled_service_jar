...
public class Trampoline extends IBackupManager.Stub {
    ...
    public void unlockSystemUser() {
        ...
        Handler h = new Handler(this.mHandlerThread.getLooper());
        h.post(new Runnable() { // from class: com.android.server.backup.-$$Lambda$Trampoline$zhmxdOntlNYAyF3FWA7uhVoZeFI
