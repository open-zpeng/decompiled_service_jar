...
public class TarBackupReader {
                ...
                if (version == 1) {
                    ...
                    if (manifestPackage.equals(info.packageName)) {
                        ...
                        if (numSigs > 0) {
                            ...
                            int offset8 = offset7;
                            for (int offset9 = 0; offset9 < numSigs; offset9++) {
                                try {
                                    offset8 = extractLine(buffer, offset8, str);
                                    sigs[offset9] = new Signature(str[0]);
                    ...
                    this.mMonitor = BackupManagerMonitorUtils.monitorEvent(this.mMonitor, 44, null, 3, BackupManagerMonitorUtils.putMonitoringExtra(monitoringExtras2, "android.app.backup.extra.LOG_EVENT_PACKAGE_VERSION", (long) version));
                }
        ...
        try {
            ...
            if ((32768 & flags) != 0) {
                ...
                if (AppBackupUtils.signaturesMatch(signatures, pkgInfo, pmi)) {
                    if ((pkgInfo.applicationInfo.flags & DumpState.DUMP_INTENT_FILTER_VERIFIERS) != 0) {
    ...
    private boolean readPaxExtendedHeader(FileMetadata info) throws IOException {
        ...
        do {
            ...
            int value2 = key + 1;
            while (data[value2] != 61 && value2 <= eol2) {
                value2++;
            }
            if (value2 > eol2) {
                throw new IOException("Invalid pax declaration");
            }
            String keyStr = new String(data, key, value2 - key, "UTF-8");
            String valStr = new String(data, value2 + 1, (eol2 - value2) - 1, "UTF-8");
            ...
            value = offset + linelen;
        } while (value < contentSize);
        return true;
    }
