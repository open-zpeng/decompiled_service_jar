...
public class FullBackupEngine {
    ...
    public void sendQuotaExceeded(final long backupDataBytes, final long quotaBytes) {
        if (initializeAgent()) {
            try {
                RemoteCall.execute(new RemoteCallable() { // from class: com.android.server.backup.fullbackup.-$$Lambda$FullBackupEngine$LOxiPZZ-0md-PJkeX7qAKOXet5g
                    @Override // com.android.server.backup.remote.RemoteCallable
                    public final void call(Object obj) {
                        FullBackupEngine.this.lambda$sendQuotaExceeded$0$FullBackupEngine(backupDataBytes, quotaBytes, (IBackupCallback) obj);
                    }
