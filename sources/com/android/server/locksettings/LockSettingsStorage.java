...
public class LockSettingsStorage {
    ...
    private byte[] readFile(String name) {
        ...
        synchronized (this.mCache) {
            ...
            try {
                try {
                    raf = new RandomAccessFile(name, ActivityTaskManagerService.DUMP_RECENTS_SHORT_CMD);
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(10:3|4|5|(6:10|11|12|13|14|15)|24|11|12|13|14|15) */
    ...
    */
    private void writeFile(java.lang.String r8, byte[] r9) {
        /*
            ...
            monitor-enter(r0)
            r1 = 0
            java.io.RandomAccessFile r2 = new java.io.RandomAccessFile     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            java.lang.String r3 = "rws"
            r2.<init>(r8, r3)     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            r1 = r2
            if (r9 == 0) goto L19
            int r2 = r9.length     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            if (r2 != 0) goto L13
            goto L19
        L13:
            r2 = 0
            int r3 = r9.length     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            r1.write(r9, r2, r3)     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            goto L1e
        L19:
            r2 = 0
            r1.setLength(r2)     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
        L1e:
            r1.close()     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            java.io.File r2 = new java.io.File     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            r2.<init>(r8)     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            java.io.File r2 = r2.getAbsoluteFile()     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            java.io.File r2 = r2.getParentFile()     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            r7.fsyncDirectory(r2)     // Catch: java.lang.Throwable -> L4f java.io.IOException -> L51
            r1.close()     // Catch: java.io.IOException -> L36 java.lang.Throwable -> Laa
        L35:
            goto L84
        L36:
            r2 = move-exception
        ...
        L4a:
            android.util.Slog.e(r3, r4)     // Catch: java.lang.Throwable -> Laa
            goto L84
        L4f:
            r2 = move-exception
            goto L8b
        L51:
            ...
            android.util.Slog.e(r3, r4)     // Catch: java.lang.Throwable -> L4f
            if (r1 == 0) goto L84
            r1.close()     // Catch: java.io.IOException -> L6f java.lang.Throwable -> Laa
            goto L35
        L6f:
            r2 = move-exception
            java.lang.String r3 = "LockSettingsStorage"
            ...
            goto L4a
        L84:
            com.android.server.locksettings.LockSettingsStorage$Cache r2 = r7.mCache     // Catch: java.lang.Throwable -> Laa
            r2.putFile(r8, r9)     // Catch: java.lang.Throwable -> Laa
        ...
        L91:
            ...
            android.util.Slog.e(r4, r5)     // Catch: java.lang.Throwable -> Laa
        La8:
