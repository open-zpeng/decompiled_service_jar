...
public class RecoverableKeyGenerator {
    ...
    public byte[] generateAndStoreKey(PlatformEncryptionKey platformKey, int userId, int uid, String alias) throws RecoverableKeyStorageException, KeyStoreException, InvalidKeyException {
    ...
    public void importKey(PlatformEncryptionKey platformKey, int userId, int uid, String alias, byte[] keyBytes) throws RecoverableKeyStorageException, KeyStoreException, InvalidKeyException {
