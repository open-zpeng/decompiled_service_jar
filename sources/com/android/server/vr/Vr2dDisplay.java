    ...
    */
    public void setVirtualDisplayProperties(android.app.Vr2dDisplayProperties r10) {
        ...
        L46:
            ...
            android.util.Log.i(r6, r7)     // Catch: java.lang.Throwable -> La5
        L6c:
            int r6 = r10.getFlags()     // Catch: java.lang.Throwable -> La5
            r6 = r6 & r5
            if (r6 != r5) goto L76
    ...
    private void startVirtualDisplay() {
        ...
        synchronized (this.mVdLock) {
            ...
            int flags = 64 | 128;
            this.mVirtualDisplay = this.mDisplayManager.createVirtualDisplay(null, DISPLAY_NAME, this.mVirtualDisplayWidth, this.mVirtualDisplayHeight, this.mVirtualDisplayDpi, null, flags | 1 | 8 | 256, null, null, UNIQUE_DISPLAY_ID);
            if (this.mVirtualDisplay != null) {
