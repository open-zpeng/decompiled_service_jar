...
public class CameraStatsJobService extends JobService {
    ...
    public static void schedule(Context context) {
        ...
        if (js == null) {
            ...
            js.schedule(new JobInfo.Builder(CAMERA_REPORTING_JOB_ID, sCameraStatsJobServiceName).setMinimumLatency(TimeUnit.DAYS.toMillis(1L)).setRequiresDeviceIdle(true).build());
        }
    }
}
