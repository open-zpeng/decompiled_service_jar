...
public class EventLogTags {
    ...
    public static void writeBatterySaverMode(int prevofforon, int nowofforon, int interactive, String features, int reason) {
        EventLog.writeEvent((int) BATTERY_SAVER_MODE, Integer.valueOf(prevofforon), Integer.valueOf(nowofforon), Integer.valueOf(interactive), features, Integer.valueOf(reason));
    }
