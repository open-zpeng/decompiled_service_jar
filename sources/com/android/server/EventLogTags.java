...
public class EventLogTags {
    ...
    public static final int NETSTATS_ETHERNET_SAMPLE = 51100;
    ...
    public static final int TIME_NETWORK_UPDATE = 51700;
    ...
    public static void writeNetstatsEthernetSample(long devRxBytes, long devTxBytes, long devRxPkts, long devTxPkts, long xtRxBytes, long xtTxBytes, long xtRxPkts, long xtTxPkts, long uidRxBytes, long uidTxBytes, long uidRxPkts, long uidTxPkts, long trustedTime) {
        EventLog.writeEvent((int) NETSTATS_ETHERNET_SAMPLE, Long.valueOf(devRxBytes), Long.valueOf(devTxBytes), Long.valueOf(devRxPkts), Long.valueOf(devTxPkts), Long.valueOf(xtRxBytes), Long.valueOf(xtTxBytes), Long.valueOf(xtRxPkts), Long.valueOf(xtTxPkts), Long.valueOf(uidRxBytes), Long.valueOf(uidTxBytes), Long.valueOf(uidRxPkts), Long.valueOf(uidTxPkts), Long.valueOf(trustedTime));
    }
    ...
    public static void writeTimeNetworkUpdate(long time) {
        EventLog.writeEvent((int) TIME_NETWORK_UPDATE, time);
    }
}
