...
final class FieldClassificationStrategy {
    ...
    public String[] getAvailableAlgorithms() {
        return (String[]) getMetadataValue("android.autofill.field_classification.available_algorithms", new MetadataParser() { // from class: com.android.server.autofill.-$$Lambda$FieldClassificationStrategy$NQQgQ63vxhPkiwOWrnwRyuYSHTM
    ...
    public String getDefaultAlgorithm() {
        return (String) getMetadataValue("android.autofill.field_classification.default_algorithm", new MetadataParser() { // from class: com.android.server.autofill.-$$Lambda$FieldClassificationStrategy$vGIL1YGX_9ksoSV74T7gO4fkEBE
            @Override // com.android.server.autofill.FieldClassificationStrategy.MetadataParser
            public final Object get(Resources resources, int i) {
                String string;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void getScores(final RemoteCallback callback, final String algorithmName, final Bundle algorithmArgs, final List<AutofillValue> actualValues, final String[] userDataValues) {
        connectAndRun(new Command() { // from class: com.android.server.autofill.-$$Lambda$FieldClassificationStrategy$gMvCLMmbA3vJ4CLoCwKkhYrCMsQ
            ...
            public final void run(IAutofillFieldClassificationService iAutofillFieldClassificationService) {
                iAutofillFieldClassificationService.getScores(callback, algorithmName, algorithmArgs, actualValues, userDataValues);
            }
        });
    }
