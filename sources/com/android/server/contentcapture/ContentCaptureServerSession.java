...
public final class ContentCaptureServerSession {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ContentCaptureServerSession(Object lock, IBinder activityToken, ContentCapturePerUserService service, ComponentName appComponentName, IResultReceiver sessionStateReceiver, int taskId, int displayId, int sessionId, int uid, int flags) {
        ...
        try {
            sessionStateReceiver.asBinder().linkToDeath(new IBinder.DeathRecipient() { // from class: com.android.server.contentcapture.-$$Lambda$ContentCaptureServerSession$PKv4-aNj3xMYOeCpzUQZDD2iG0o
