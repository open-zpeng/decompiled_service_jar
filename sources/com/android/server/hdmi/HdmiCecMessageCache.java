...
final class HdmiCecMessageCache {
    private static final FastImmutableArraySet<Integer> CACHEABLE_OPCODES = new FastImmutableArraySet<>(new Integer[]{71, 132, Integer.valueOf((int) NetworkConstants.ICMPV6_NEIGHBOR_SOLICITATION), 158});
