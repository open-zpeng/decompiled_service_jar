...
final class HdmiCecKeycode {
    ...
    private static final KeycodeEntry[] KEYCODE_ENTRIES = {new KeycodeEntry(23, 0), new KeycodeEntry(19, 1), new KeycodeEntry(20, 2), new KeycodeEntry(21, 3), new KeycodeEntry(22, 4), new KeycodeEntry(-1, 5), new KeycodeEntry(-1, 6), new KeycodeEntry(-1, 7), new KeycodeEntry(-1, 8), new KeycodeEntry(3, 9), new KeycodeEntry(176, 10), new KeycodeEntry(256, 11, false), new KeycodeEntry(-1, 12), new KeycodeEntry(4, 13), new KeycodeEntry((int) NetworkManagementService.NetdResponseCode.TetherInterfaceListResult, 13), new KeycodeEntry(226, 16), new KeycodeEntry((int) UsbTerminalTypes.TERMINAL_USB_STREAMING, 17), new KeycodeEntry(234, 29), new KeycodeEntry(227, 30), new KeycodeEntry(228, 31), new KeycodeEntry(7, 32), new KeycodeEntry(8, 33), new KeycodeEntry(9, 34), new KeycodeEntry(10, 35), new KeycodeEntry(11, 36), new KeycodeEntry(12, 37), new KeycodeEntry(13, 38), new KeycodeEntry(14, 39), new KeycodeEntry(15, 40), new KeycodeEntry(16, 41), new KeycodeEntry(56, 42), new KeycodeEntry(160, 43), new KeycodeEntry(28, 44), new KeycodeEntry(-1, 47), new KeycodeEntry(166, 48), new KeycodeEntry(167, 49), new KeycodeEntry(229, 50), new KeycodeEntry(-1, 51), new KeycodeEntry((int) UI_SOUND_PRESENTATION_BASS_NEUTRAL, 52), new KeycodeEntry(165, 53), new KeycodeEntry(-1, 54), new KeycodeEntry(92, 55), new KeycodeEntry(93, 56), new KeycodeEntry(26, 64, false), new KeycodeEntry(24, 65), new KeycodeEntry(25, 66), new KeycodeEntry(164, 67, false), new KeycodeEntry(126, 68), new KeycodeEntry(86, 69), new KeycodeEntry(127, 70), new KeycodeEntry(85, 70), new KeycodeEntry(130, 71), new KeycodeEntry(89, 72), new KeycodeEntry(90, 73), new KeycodeEntry((int) NetworkConstants.ICMPV6_ECHO_REPLY_TYPE, 74), new KeycodeEntry(87, 75), new KeycodeEntry(88, 76), new KeycodeEntry(-1, 77), new KeycodeEntry(-1, 78), new KeycodeEntry(-1, 79), new KeycodeEntry(-1, 80), new KeycodeEntry(175, 81), new KeycodeEntry(-1, 82), new KeycodeEntry(172, 83), new KeycodeEntry(258, 84), new KeycodeEntry(-1, 85), new KeycodeEntry(-1, 86), new KeycodeEntry(235, 86, true, intToSingleByteArray(16)), new KeycodeEntry(DhcpPacket.MIN_PACKET_LENGTH_BOOTP, 86, true, intToSingleByteArray(96)), new KeycodeEntry(238, 86, true, intToSingleByteArray(128)), new KeycodeEntry(UsbDescriptor.CLASSID_MISC, 86, true, intToSingleByteArray(144)), new KeycodeEntry(241, 86, true, intToSingleByteArray(1)), new KeycodeEntry(-1, 87), new KeycodeEntry(-1, 96, false), new KeycodeEntry(-1, 97, false), new KeycodeEntry(-1, 98, false), new KeycodeEntry(-1, 99, false), new KeycodeEntry(-1, 100, false), new KeycodeEntry(-1, 101, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_RESTORE_VOLUME_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_TUNE_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_SELECT_MEDIA_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_SELECT_AV_INPUT_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_SELECT_AUDIO_INPUT_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_POWER_TOGGLE_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_POWER_OFF_FUNCTION, false), new KeycodeEntry(-1, (int) CEC_KEYCODE_POWER_ON_FUNCTION, false), new KeycodeEntry(186, 113), new KeycodeEntry(183, 114), new KeycodeEntry(184, (int) CEC_KEYCODE_F3_GREEN), new KeycodeEntry(185, (int) CEC_KEYCODE_F4_YELLOW), new KeycodeEntry((int) NetworkConstants.ICMPV6_NEIGHBOR_SOLICITATION, (int) CEC_KEYCODE_F5), new KeycodeEntry(230, (int) CEC_KEYCODE_DATA)};
