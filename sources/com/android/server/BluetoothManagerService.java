...
public class BluetoothManagerService extends IBluetoothManager.Stub {
        ...
        public void onChange(boolean unused) {
            ...
            synchronized (this) {
                ...
                try {
                    ...
                    Slog.i(BluetoothManagerService.TAG, "Airplane Mode change - current state:  " + BluetoothAdapter.nameForState(st));
                    if (BluetoothManagerService.this.isAirplaneModeOn()) {
    ...
    public boolean disable(String packageName, boolean persist) throws RemoteException {
        ...
        Slog.i(TAG, "disable(): mBluetooth = " + this.mBluetooth + " mBinding = " + this.mBinding);
        synchronized (this.mReceiver) {
            if (persist) {
                try {
