...
public class NetworkScorerAppManager {
    ...
    private boolean canAccessLocation(int uid, String packageName) {
        ...
        return isLocationModeEnabled() && pm.checkPermission("android.permission.ACCESS_COARSE_LOCATION", packageName) == 0 && appOpsManager.noteOp(0, uid, packageName) == 0;
    }
    ...
    private String getDefaultPackageSetting() {
        return this.mContext.getResources().getString(17039658);
    }
