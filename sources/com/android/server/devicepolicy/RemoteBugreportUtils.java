...
class RemoteBugreportUtils {
    ...
    public static Notification buildNotification(Context context, int type) {
        ...
        Notification.Builder builder = new Notification.Builder(context, SystemNotificationChannels.DEVELOPER).setSmallIcon(17303459).setOngoing(true).setLocalOnly(true).setContentIntent(pendingDialogIntent).setColor(context.getColor(17170861));
        if (type == 2) {
            builder.setContentTitle(context.getString(17040872)).setProgress(0, 0, true);
        } else if (type == 1) {
            builder.setContentTitle(context.getString(17040976)).setProgress(0, 0, true);
        } else if (type == 3) {
            ...
            builder.addAction(new Notification.Action.Builder((Icon) null, context.getString(17039788), pendingIntentDecline).build()).addAction(new Notification.Action.Builder((Icon) null, context.getString(17040867), pendingIntentAccept).build()).setContentTitle(context.getString(17040869)).setContentText(context.getString(17040868)).setStyle(new Notification.BigTextStyle().bigText(context.getString(17040868)));
        }
