...
class AbUpdateInstaller extends UpdateInstaller {
    ...
    private void applyPayload(String updatePath) throws IOException {
        ...
        String[] headerKeyValuePairs = (String[]) this.mProperties.stream().toArray(new IntFunction() { // from class: com.android.server.devicepolicy.-$$Lambda$AbUpdateInstaller$jqambsFSkRKkP2tdaidkN0h_SUo
