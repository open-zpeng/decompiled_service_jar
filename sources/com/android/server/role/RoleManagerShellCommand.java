...
public class RoleManagerShellCommand extends ShellCommand {
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x0057 A[Catch: RemoteException -> 0x005c, TRY_LEAVE, TryCatch #0 {RemoteException -> 0x005c, blocks: (B:6:0x000c, B:26:0x0048, B:28:0x004d, B:30:0x0052, B:32:0x0057, B:13:0x0022, B:16:0x002d, B:19:0x0037), top: B:37:0x000c }] */
    /*
    ...
    */
    public int onCommand(java.lang.String r7) {
        ...
        L7:
            ...
            r1 = -1
            int r2 = r7.hashCode()     // Catch: android.os.RemoteException -> L5c
        ...
        L22:
            ...
            boolean r2 = r7.equals(r2)     // Catch: android.os.RemoteException -> L5c
            if (r2 == 0) goto L21
            r2 = r5
            goto L42
        L2d:
        ...
        L42:
            ...
            if (r2 == r5) goto L52
            if (r2 == r4) goto L4d
            int r1 = r6.handleDefaultCommands(r7)     // Catch: android.os.RemoteException -> L5c
            return r1
        L4d:
            int r1 = r6.runClearRoleHolders()     // Catch: android.os.RemoteException -> L5c
            return r1
        L52:
            int r1 = r6.runRemoveRoleHolder()     // Catch: android.os.RemoteException -> L5c
            return r1
        L57:
            int r1 = r6.runAddRoleHolder()     // Catch: android.os.RemoteException -> L5c
            return r1
        L5c:
            r2 = move-exception
