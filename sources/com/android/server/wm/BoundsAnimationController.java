...
public class BoundsAnimationController {
    ...
    public BoundsAnimationController(Context context, AppTransition transition, Handler handler, final AnimationHandler animationHandler) {
        ...
        if (animationHandler != null) {
            handler.post(new Runnable() { // from class: com.android.server.wm.-$$Lambda$BoundsAnimationController$3-yWz6AXIW5r1KElGtHEgHZdi5Q
                @Override // java.lang.Runnable
                public final void run() {
                    BoundsAnimationController.this.lambda$new$0$BoundsAnimationController(animationHandler);
                }
            });
        }
    }
    ...
    public final class BoundsAnimator extends ValueAnimator implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
        ...
        public void onAnimationStart(Animator animation) {
            ...
            if (i == 0) {
                continueAnimation = this.mTarget.onAnimationStart(this.mSchedulePipModeChangedState == 1, false, this.mAnimationType);
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if (this.mAnimationType == 1) {
                if (!this.mTarget.setPinnedStackAlpha(value)) {
    ...
    @VisibleForTesting
    BoundsAnimator animateBoundsImpl(BoundsAnimationTarget target, Rect from, Rect to, int animationDuration, int schedulePipModeChangedState, boolean moveFromFullscreen, boolean moveToFullscreen, @AnimationType int animationType) {
        int animationType2;
        ...
        if (animationType2 == 1) {
            ...
            j = (animationDuration != -1 ? animationDuration : DEFAULT_TRANSITION_DURATION) * 1;
        }
