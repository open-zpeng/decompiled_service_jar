                        ...
                        try {
                            ...
                            try {
                                ...
                                for (int i2 = 0; i2 < numDisplays; i2++) {
                                    ...
                                    DisplayContent dc2 = this.mService.mRoot.getDisplayContent(displayId2);
                                    ...
                                    if (accessibilityController != null && dc2.isDefaultDisplay) {
                            ...
                            boolean doRequest = this.mBulkUpdateParams != 0 ? this.mService.mRoot.copyAnimToLayoutParams() : false;
