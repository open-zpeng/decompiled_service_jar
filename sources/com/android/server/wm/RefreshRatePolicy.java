...
public class RefreshRatePolicy {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public RefreshRatePolicy(WindowManagerService wmService, DisplayInfo displayInfo, HighRefreshRateBlacklist blacklist) {
    ...
    private int findLowRefreshRateModeId(DisplayInfo displayInfo) {
        ...
        int i2 = displayInfo.findDefaultModeByRefreshRate(bestRefreshRate);
        return i2;
    }
