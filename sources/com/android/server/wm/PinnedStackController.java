...
public class PinnedStackController {
        ...
        public void setIsMinimized(final boolean isMinimized) {
            PinnedStackController.this.mHandler.post(new Runnable() { // from class: com.android.server.wm.-$$Lambda$PinnedStackController$PinnedStackControllerCallback$0SANOJyiLP67Pkj3NbDS5B-egBU
                ...
                public final void run() {
                    PinnedStackController.PinnedStackControllerCallback.lambda$setIsMinimized$0(PinnedStackController.PinnedStackControllerCallback.this, isMinimized);
                }
            });
        }
    ...
    private void reloadResources() {
        ...
        this.mDefaultMinSize = res.getDimensionPixelSize(17105036);
        this.mCurrentMinSize = this.mDefaultMinSize;
        this.mDefaultAspectRatio = res.getFloat(17104988);
        String screenEdgeInsetsDpString = res.getString(17039660);
        ...
        this.mMinAspectRatio = res.getFloat(17104991);
        this.mMaxAspectRatio = res.getFloat(17104990);
    }
