...
public class WindowChangeAnimationSpec implements LocalAnimationAdapter.AnimationSpec {
    ...
    private final ThreadLocal<TmpValues> mThreadLocalTmps = ThreadLocal.withInitial(new Supplier() { // from class: com.android.server.wm.-$$Lambda$WindowChangeAnimationSpec$J5jIvng4n-ctFR8T6L2f_W3o1KU
        @Override // java.util.function.Supplier
        public final Object get() {
            return WindowChangeAnimationSpec.lambda$new$0();
        }
    });
