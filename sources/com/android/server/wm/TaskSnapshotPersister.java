...
public class TaskSnapshotPersister {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public TaskSnapshotPersister(DirectoryResolver resolver) {
    ...
    public class StoreWriteQueueItem extends WriteQueueItem {
        ...
        boolean writeBuffer() {
            ...
            if (bitmap != null) {
                ...
                Bitmap reduced = this.mSnapshot.isReducedResolution() ? swBitmap : Bitmap.createScaledBitmap(swBitmap, (int) (bitmap.getWidth() * TaskSnapshotPersister.REDUCED_SCALE), (int) (bitmap.getHeight() * TaskSnapshotPersister.REDUCED_SCALE), true);
                try {
