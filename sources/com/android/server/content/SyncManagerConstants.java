...
public class SyncManagerConstants extends ContentObserver {
    ...
    public void start() {
        BackgroundThread.getHandler().post(new Runnable() { // from class: com.android.server.content.-$$Lambda$SyncManagerConstants$qo5ldQVp10jCUY9aavBZDKP2k6Q
            @Override // java.lang.Runnable
            public final void run() {
                SyncManagerConstants.lambda$start$0(SyncManagerConstants.this);
            }
        });
    }
