...
public final class Usb10ACInputTerminal extends UsbACTerminal {
    ...
    public void report(ReportCanvas canvas) {
        ...
        canvas.writeListItem(BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) getNrChannels()) + " Chans. Config: " + ReportCanvas.getHexString(getChannelConfig()));
        canvas.closeList();
    }
}
