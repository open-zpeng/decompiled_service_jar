...
public final class Usb20ACInputTerminal extends UsbACTerminal {
    ...
    public void report(ReportCanvas canvas) {
        ...
        canvas.writeListItem(BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) getNumChannels()) + " Channels. Config: " + ReportCanvas.getHexString(getChanConfig()));
        canvas.closeList();
    }
}
