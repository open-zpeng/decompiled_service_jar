...
public final class UsbDeviceDescriptor extends UsbDescriptor {
    ...
    public UsbDevice.Builder toAndroid(UsbDescriptorParser parser) {
        ...
        UsbDevice.Builder device = new UsbDevice.Builder(parser.getDeviceAddr(), this.mVendorID, this.mProductID, this.mDevClass, this.mDevSubClass, this.mProtocol, mfgName, prodName, versionString, configs, serialStr);
        return device;
    }
