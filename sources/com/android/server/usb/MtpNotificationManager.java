...
public class MtpNotificationManager {
    ...
    public void showNotification(UsbDevice device) {
        ...
        String title = resources.getString(17041188, device.getProductName());
        String description = resources.getString(17041187);
        Notification.Builder builder = new Notification.Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(title).setContentText(description).setSmallIcon(17303557).setCategory("sys");
