...
public final class UsbMidiDevice implements Closeable {
    ...
    /* JADX WARN: Type inference failed for: r6v0, types: [com.android.server.usb.UsbMidiDevice$2] */
                        ...
                        synchronized (UsbMidiDevice.this.mLock) {
                            ...
                            while (true) {
                                ...
                                if ((pfd.revents & OsConstants.POLLIN) != 0) {
                                    ...
                                    int count = UsbMidiDevice.this.mInputStreams[index2].read(buffer);
                                    outputReceivers[index2].send(buffer, 0, count, timestamp);
                                }
                                index = index2 + 1;
                            }
                        }
