...
public class UsbDeviceManager implements ActivityManagerInternal.ScreenObserver {
    ...
    public UsbDeviceManager(Context context, UsbAlsaManager alsaManager, UsbSettingsManager settingsManager) {
        ...
        if (halNotPresent2) {
            this.mHandler = new UsbHandlerLegacy(FgThread.get().getLooper(), this.mContext, this, this.mDebuggingManager, alsaManager, settingsManager);
        } else {
    ...
    public static abstract class UsbHandler extends Handler {
        ...
        UsbHandler(Looper looper, Context context, UsbDeviceManager deviceManager, UsbDebuggingManager debuggingManager, UsbAlsaManager alsaManager, UsbSettingsManager settingsManager) {
            super(looper);
            this.mContext = context;
            ...
            this.mUseUsbNotification = (massStorageSupported || !this.mContext.getResources().getBoolean(17957063)) ? false : z;
        }
        ...
        */
        private void updateMidiFunction() {
            ...
            L33:
                r4 = move-exception
                java.lang.String r5 = com.android.server.usb.UsbDeviceManager.access$400()     // Catch: java.lang.Throwable -> L31
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 3:
                    ...
                    if (isTv()) {
                        this.mNotificationManager.createNotificationChannel(new NotificationChannel(UsbDeviceManager.ADB_NOTIFICATION_CHANNEL_ID_TV, this.mContext.getString(17039445), 4));
                    }
        ...
        protected void updateUsbNotification(boolean force) {
            ...
            CharSequence message = r.getText(17041021);
            ...
            if (id != this.mUsbNotificationId || force) {
                ...
                if (id != 0) {
                    ...
                    if (titleRes != 17041027) {
                        ...
                        String channel2 = SystemNotificationChannels.USB;
                        channel = channel2;
                    } else {
                        ...
                        message = r.getText(17041026);
                    }
                    Notification.Builder builder = new Notification.Builder(this.mContext, channel).setSmallIcon(17303459).setWhen(0L).setOngoing(true).setTicker(title).setDefaults(0).setColor(this.mContext.getColor(17170861)).setContentTitle(title).setContentText(message).setContentIntent(pi).setVisibility(1);
                    if (titleRes == 17041027) {
        ...
        protected void updateAdbNotification(boolean force) {
            ...
            if (this.mAdbEnabled && this.mConnected) {
                ...
                if (!this.mAdbNotificationShown) {
                    Resources r = this.mContext.getResources();
                    CharSequence title = r.getText(17039444);
                    CharSequence message = r.getText(17039443);
                    Intent intent = new Intent("android.settings.APPLICATION_DEVELOPMENT_SETTINGS");
                    intent.addFlags(268468224);
                    PendingIntent pi = PendingIntent.getActivityAsUser(this.mContext, 0, intent, 0, null, UserHandle.CURRENT);
                    Notification notification = new Notification.Builder(this.mContext, SystemNotificationChannels.DEVELOPER).setSmallIcon(17303459).setWhen(0L).setOngoing(true).setTicker(title).setDefaults(0).setColor(this.mContext.getColor(17170861)).setContentTitle(title).setContentText(message).setContentIntent(pi).setVisibility(1).extend(new Notification.TvExtender().setChannelId(UsbDeviceManager.ADB_NOTIFICATION_CHANNEL_ID_TV)).build();
        ...
        public void dump(DualDumpOutputStream dump, String idName, long id) {
            ...
            if (this.mCurrentAccessory != null) {
                DumpUtils.writeAccessory(dump, "current_accessory", 1146756268039L, this.mCurrentAccessory);
            }
            ...
            dump.write("adb_enabled", 1133871366158L, this.mAdbEnabled);
            try {
    ...
    private static final class UsbHandlerLegacy extends UsbHandler {
        ...
        private void readOemUsbOverrideConfig(Context context) {
            String[] configList = context.getResources().getStringArray(17236029);
            if (configList != null) {
    ...
    private static final class UsbHandlerHal extends UsbHandler {
        ...
        UsbHandlerHal(Looper looper, Context context, UsbDeviceManager deviceManager, UsbDebuggingManager debuggingManager, UsbAlsaManager alsaManager, UsbSettingsManager settingsManager) {
            ...
            try {
                ...
                boolean ret = IServiceManager.getService().registerForNotifications("android.hardware.usb.gadget@1.0::IUsbGadget", BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS, serviceNotification);
                if (!ret) {
