        ...
        public void onChange() {
            ...
            if (this.mEnabled != enabled) {
                if (enabled) {
                    ...
                    Binder.setWorkSourceProvider(new BinderInternal.WorkSourceProvider() { // from class: com.android.server.-$$Lambda$BinderCallsStatsService$SettingsObserver$bif9uA0lzoT6htcKe6MNsrH_ha4
