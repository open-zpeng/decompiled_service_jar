...
public class LegacyGlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    private ActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302453, 17302455, 17040077, 17040076, 17040075) { // from class: com.android.server.policy.LegacyGlobalActions.1
    ...
    public class BugReportAction extends SinglePressAction implements LongPressAction {
        ...
        public String getStatus() {
            return LegacyGlobalActions.this.mContext.getString(17039623, Build.VERSION.RELEASE, Build.ID);
        }
    }

    private Action getSettingsAction() {
        return new SinglePressAction(17302801, 17040069) { // from class: com.android.server.policy.LegacyGlobalActions.3
            public void onPress() {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302204, 17040062) { // from class: com.android.server.policy.LegacyGlobalActions.4
            public void onPress() {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302286, 17040060) { // from class: com.android.server.policy.LegacyGlobalActions.5
            public void onPress() {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302841, 17040073) { // from class: com.android.server.policy.LegacyGlobalActions.6
            public void onPress() {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040064) { // from class: com.android.server.policy.LegacyGlobalActions.7
            public void onPress() {
        ...
        if (um.isUserSwitcherEnabled()) {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    ...
                    SinglePressAction switchToUser = new SinglePressAction(17302676, icon, sb.toString()) { // from class: com.android.server.policy.LegacyGlobalActions.8
                        public void onPress() {
                            try {
