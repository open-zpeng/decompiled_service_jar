...
public class NewNetworkTimeUpdateService extends Binder implements NetworkTimeUpdateService {
    ...
    private BroadcastReceiver mNitzReceiver = new BroadcastReceiver() { // from class: com.android.server.NewNetworkTimeUpdateService.2
    ...
    private void registerForAlarms() {
        this.mContext.registerReceiver(new BroadcastReceiver() { // from class: com.android.server.NewNetworkTimeUpdateService.1
            @Override // android.content.BroadcastReceiver
            public void onReceive(Context context, Intent intent) {
    ...
    private void updateSystemClock(int event) {
        ...
        EventLogTags.writeTimeNetworkUpdate(this.mTime.currentTimeMillis());
    ...
    private class NetworkTimeUpdateCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Log.d(NewNetworkTimeUpdateService.TAG, String.format("New default network %s; checking time.", network));
