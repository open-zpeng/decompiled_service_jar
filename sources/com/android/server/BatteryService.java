...
public final class BatteryService extends SystemService {
            ...
            if (this.mPlugType != this.mLastPlugType) {
                if (this.mLastPlugType == 0) {
                    ...
                    if (this.mDischargeStartTime != 0 && this.mDischargeStartLevel != this.mHealthInfo.batteryLevel) {
                        ...
                        logOutlier = true;
                        EventLog.writeEvent((int) EventLogTags.BATTERY_DISCHARGE, Long.valueOf(dischargeDuration2), Integer.valueOf(this.mDischargeStartLevel), Integer.valueOf(this.mHealthInfo.batteryLevel));
    ...
    private int getIconLocked(int level) {
        ...
        if (this.mHealthInfo.batteryStatus == 4 || this.mHealthInfo.batteryStatus == 5) {
            return (!isPoweredLocked(7) || this.mHealthInfo.batteryLevel < 100) ? 17303460 : 17303474;
        }
        return 17303488;
    }
