...
public final class ColorDisplayService extends SystemService {
    ...
    private void setUpDisplayCompositionColorSpaces(Resources res) {
        int[] compSpaces;
        this.mColorModeCompositionColorSpaces = null;
        int[] colorModes = res.getIntArray(17236013);
        if (colorModes == null || (compSpaces = res.getIntArray(17236014)) == null) {
            return;
        }
    ...
    public void onDisplayColorModeChanged(int mode) {
        ...
        dtm.setColorMode(mode, this.mNightDisplayTintController.getMatrix(), getCompositionColorSpace(mode));
        if (this.mDisplayWhiteBalanceTintController.isAvailable(getContext())) {
            updateDisplayWhiteBalanceStatus();
        }
    }
    ...
    public void onAccessibilityInversionChanged() {
        ...
        DisplayTransformManager dtm = (DisplayTransformManager) getLocalService(DisplayTransformManager.class);
        dtm.setColorMatrix(DisplayTransformManager.LEVEL_COLOR_MATRIX_INVERT_COLOR, isAccessiblityInversionEnabled() ? MATRIX_INVERT_COLOR : null);
    }
    ...
    public void applyTint(final TintController tintController, boolean immediate) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.server.display.color.-$$Lambda$ColorDisplayService$3e7BuPerYILI5JPZm17hU11tDtY
    ...
    public boolean isDisplayWhiteBalanceSettingEnabled() {
        ...
        return Settings.Secure.getIntForUser(getContext().getContentResolver(), "display_white_balance_enabled", getContext().getResources().getBoolean(17891414) ? 1 : 0, this.mCurrentUser) == 1;
    }
    ...
    private int getCurrentColorModeFromSystemProperties() {
        ...
        if (displayColorSetting != 0) {
            ...
            return -1;
        } else if ("1.0".equals(SystemProperties.get("persist.sys.sf.color_saturation"))) {
            return 0;
        } else {
            return 1;
        }
    ...
    private boolean isColorModeAvailable(int colorMode) {
        int[] availableColorModes = getContext().getResources().getIntArray(17235992);
    ...
    public final class NightDisplayTintController extends TintController {
        ...
        private int clampNightDisplayColorTemperature(int colorTemperature) {
            if (colorTemperature == -1) {
                colorTemperature = ColorDisplayService.this.getContext().getResources().getInteger(17694858);
            }
    ...
    public final class ColorDisplayServiceInternal {
        ...
        public boolean resetDisplayWhiteBalanceColorTemperature() {
            int temperatureDefault = ColorDisplayService.this.getContext().getResources().getInteger(17694789);
