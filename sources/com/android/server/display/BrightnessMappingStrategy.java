...
public abstract class BrightnessMappingStrategy {
    ...
    public static BrightnessMappingStrategy create(Resources resources) {
        float[] luxLevels = getLuxLevels(resources.getIntArray(17235990));
        int[] brightnessLevelsBacklight = resources.getIntArray(17235989);
        ...
        float[] nitsRange = getFloatArray(resources.obtainTypedArray(17236066));
        int[] backlightRange = resources.getIntArray(17236065);
        if (isValidMapping(nitsRange, backlightRange) && isValidMapping(luxLevels, brightnessLevelsNits)) {
            int minimumBacklight = resources.getInteger(17694888);
            int maximumBacklight = resources.getInteger(17694887);
