...
final class DisplayDeviceInfo {
    ...
    public void setAssumedDensityForExternalDisplay(int width, int height) {
        ...
        int density = SystemProperties.getInt("vendor.display.lcd_density", 160);
        this.densityDpi = Math.min(this.densityDpi, density);
        int foDensity = FeatureOption.FO_EXTERNAL_DISPLAY_DENSITY;
        if (foDensity > 0) {
            this.densityDpi = foDensity;
        }
