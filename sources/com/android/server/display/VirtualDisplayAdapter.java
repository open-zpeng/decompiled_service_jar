    ...
    public final class VirtualDisplayDevice extends DisplayDevice implements IBinder.DeathRecipient {
        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            if (this.mInfo == null) {
                ...
                displayDeviceInfo3.presentationDeadlineNanos = 16666666L;
                ...
                displayDeviceInfo4.touch = (this.mFlags & 64) == 0 ? 0 : 3;
                this.mInfo.state = this.mIsDisplayOn ? 2 : 1;
                DisplayDeviceInfo displayDeviceInfo5 = this.mInfo;
                displayDeviceInfo5.ownerUid = this.mOwnerUid;
                displayDeviceInfo5.ownerPackageName = this.mOwnerPackageName;
            }
            return this.mInfo;
        }
    }
