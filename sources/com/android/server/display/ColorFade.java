...
public final class ColorFade {
        ...
        if (this.mPrepared) {
            ...
            if (attachEglContext()) {
                try {
                    ...
                    float gamma = (float) (0.1d + (((sign * 0.5d * Math.pow(cos, 2.0d)) + 0.5d) * 0.9d));
    ...
    private boolean captureScreenshotTextureAndSetViewport() {
        if (attachEglContext()) {
            try {
                ...
                this.mIsWideColor = SurfaceControl.getActiveColorMode(token) == 9;
    ...
    private boolean createEglSurface() {
        if (this.mEglSurface == null) {
            int[] eglSurfaceAttribList = {12344, 12344, 12344};
            if (this.mIsWideColor) {
