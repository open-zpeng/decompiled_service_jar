...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039882, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039881);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        ...
        this.mWindowContent = inflater.inflate(17367222, (ViewGroup) null);
        this.mWindowContent.setOnTouchListener(this.mOnTouchListener);
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909309);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909310);
