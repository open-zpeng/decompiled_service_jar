...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039819, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039818);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        ...
        this.mWindowContent = inflater.inflate(17367210, (ViewGroup) null);
        this.mWindowContent.setOnTouchListener(this.mOnTouchListener);
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909249);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909250);
