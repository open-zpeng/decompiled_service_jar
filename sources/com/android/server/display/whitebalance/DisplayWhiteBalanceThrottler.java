...
class DisplayWhiteBalanceThrottler {
    ...
    public DisplayWhiteBalanceThrottler(int increaseDebounce, int decreaseDebounce, float[] baseThresholds, float[] increaseThresholds, float[] decreaseThresholds) {
    ...
    private boolean tooSoon(float value) {
        ...
        if (value > this.mLastValue) {
            earliestTime = this.mLastTime + this.mIncreaseDebounce;
        } else {
            long earliestTime2 = this.mLastTime;
            earliestTime = earliestTime2 + this.mDecreaseDebounce;
        }
