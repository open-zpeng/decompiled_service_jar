    ...
    private void updateOverlayDisplayDevicesLocked() {
        ...
        while (i < length) {
            ...
            if (!displayMatcher2.matches()) {
                ...
                String[] split2 = modeString.split(xpInputManagerService.OR);
                ...
                if (!modes.isEmpty()) {
                    int count2 = count + 1;
                    boolean z = true;
                    String name = getContext().getResources().getString(17039880, Integer.valueOf(count2));
    ...
    private abstract class OverlayDisplayDevice extends DisplayDevice {
        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            if (this.mInfo == null) {
                ...
                displayDeviceInfo3.presentationDeadlineNanos = this.mDisplayPresentationDeadlineNanos + (1000000000 / ((int) this.mRefreshRate));
