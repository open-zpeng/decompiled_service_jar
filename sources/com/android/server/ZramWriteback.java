...
public final class ZramWriteback extends JobService {
    ...
    public static void schedNextWriteback(Context context) {
        ...
        js.schedule(new JobInfo.Builder(WRITEBACK_IDLE_JOB_ID, sZramWriteback).setMinimumLatency(TimeUnit.HOURS.toMillis(nextWbDelay)).setRequiresDeviceIdle(true).build());
    }
    ...
    public static void scheduleZramWriteback(Context context) {
        ...
        js.schedule(new JobInfo.Builder(WRITEBACK_IDLE_JOB_ID, sZramWriteback).setMinimumLatency(TimeUnit.MINUTES.toMillis(firstWbDelay)).setRequiresDeviceIdle(true).build());
    }
}
