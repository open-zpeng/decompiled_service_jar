...
public final class RemotePrintService implements IBinder.DeathRecipient {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void handleRequestCustomPrinterIcon(final PrinterId printerId) {
        if (!isBound()) {
            ensureBound();
    ...
    private void ensureBound() {
        ...
        this.mBinding = true;
        boolean wasBound = this.mContext.bindServiceAsUser(this.mIntent, this.mServiceConnection, 71303169, new UserHandle(this.mUserId));
        if (!wasBound) {
            this.mBinding = false;
