...
public final class RemotePrintService implements IBinder.DeathRecipient {
    ...
    public void destroy() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$tI07K2u4Z5L72sd1hvSEunGclrg
    ...
    public void binderDied() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$uBWTskFvpksxzoYevxmiaqdMXas
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onAllPrintJobsHandled() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$1cbVOJkW_ULFS1xH-T-tbALCzHI
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onRequestCancelPrintJob(PrintJobInfo printJob) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$tL9wtChZzY3dei-ul1VudkrPO20
    ...
    public void onPrintJobQueued(PrintJobInfo printJob) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$KGsYx3sHW6vGymod4UmBTazYSks
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void createPrinterDiscoverySession() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$pgSurbN2geCgHp9vfTAIFm5XvgQ
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void destroyPrinterDiscoverySession() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$ru7USNI_O2DIDwflMPlEsqA_IY4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void startPrinterDiscovery(List<PrinterId> priorityList) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$jrFOjxtIoMNm8S0KNTqIDHuv4oY
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void stopPrinterDiscovery() {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new Consumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$FH95Crnc6zH421SxRw9RxPyl0YY
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void validatePrinters(List<PrinterId> printerIds) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$q0Rw93bA7P79FpkLlFZXs5xcOoc
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void startPrinterStateTracking(PrinterId printerId) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$aHc-cJYzTXxafcxxvfW2janFHIc
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void requestCustomPrinterIcon(PrinterId printerId) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$TsHHZCuIB3sKEZ8IZ0oPokZZO6g
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                ((RemotePrintService) obj).lambda$handleRequestCustomPrinterIcon$0$RemotePrintService((PrinterId) obj2);
            }
        }, this, printerId));
    }
    ...
    public void lambda$handleRequestCustomPrinterIcon$0$RemotePrintService(final PrinterId printerId) {
        if (!isBound()) {
            ensureBound();
            this.mPendingCommands.add(new Runnable() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$e0Ck2QZDih6p896nITpWZ_zOduk
                @Override // java.lang.Runnable
                public final void run() {
                    RemotePrintService.this.lambda$handleRequestCustomPrinterIcon$0$RemotePrintService(printerId);
                }
            });
            return;
        }
    ...
    public void stopPrinterStateTracking(PrinterId printerId) {
        Handler.getMain().sendMessage(PooledLambda.obtainMessage(new BiConsumer() { // from class: com.android.server.print.-$$Lambda$RemotePrintService$L2EQSyIHled1ZVO5GCaBXmvtCQQ
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
