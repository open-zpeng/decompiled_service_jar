...
public class AppBindingService extends Binder {
    ...
    private AppBindingService(Injector injector, Context context) {
        ...
        this.mApps.add(new CarrierMessagingClientServiceFinder(context, new BiConsumer() { // from class: com.android.server.appbinding.-$$Lambda$AppBindingService$D_3boeCn8eAANOp2ZDk6OC2rNaI
    ...
    private void onPhaseThirdPartyAppsCanStart() {
        synchronized (this.mLock) {
            forAllAppsLocked(new Consumer() { // from class: com.android.server.appbinding.-$$Lambda$xkEFYM78dwFMyAjWJXkB7AxgA2c
    ...
    public void onUserRemoved(final int userId) {
        synchronized (this.mLock) {
            forAllAppsLocked(new Consumer() { // from class: com.android.server.appbinding.-$$Lambda$AppBindingService$_RrDLXlhUGfI3nzAdSavPUgy7uo
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public void dump(FileDescriptor fd, final PrintWriter pw, String[] args) {
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, pw)) {
            ...
            synchronized (this.mLock) {
                ...
                pw.println();
                pw.println("  Finders:");
                forAllAppsLocked(new Consumer() { // from class: com.android.server.appbinding.-$$Lambda$AppBindingService$C9KbqX5cmsR3luJhFKt2Gpj0uLc
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
    ...
    private void dumpSimple(final PrintWriter pw) {
        synchronized (this.mLock) {
            ...
            forAllAppsLocked(new Consumer() { // from class: com.android.server.appbinding.-$$Lambda$AppBindingService$ecbTIkvVpOcufbjzWWh2_dn3hSo
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
