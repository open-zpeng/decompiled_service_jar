...
class AccountAuthenticatorCache extends RegisteredServicesCache<AuthenticatorDescription> implements IAccountAuthenticatorCache {
    ...
    public AuthenticatorDescription m9parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
    ...
    private static class MySerializer implements XmlSerializerAndParser<AuthenticatorDescription> {
        ...
        public AuthenticatorDescription m10createFromXml(XmlPullParser parser) throws IOException, XmlPullParserException {
