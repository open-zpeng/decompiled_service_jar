...
class AccountAuthenticatorCache extends RegisteredServicesCache<AuthenticatorDescription> implements IAccountAuthenticatorCache {
    ...
    public AuthenticatorDescription m10parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
    ...
    private static class MySerializer implements XmlSerializerAndParser<AuthenticatorDescription> {
        ...
        public AuthenticatorDescription m11createFromXml(XmlPullParser parser) throws IOException, XmlPullParserException {
