    ...
    */
    public java.util.List<android.accounts.Account> getSharedAccounts() {
        /*
            ...
            java.lang.String[] r5 = new java.lang.String[]{r1, r0}     // Catch: java.lang.Throwable -> L51
            r6 = 0
            r7 = 0
            r8 = 0
            r9 = 0
            ...
            r12 = r3
            if (r12 == 0) goto L4b
            boolean r3 = r12.moveToFirst()     // Catch: java.lang.Throwable -> L51
            if (r3 == 0) goto L4b
            int r1 = r12.getColumnIndex(r1)     // Catch: java.lang.Throwable -> L51
            int r0 = r12.getColumnIndex(r0)     // Catch: java.lang.Throwable -> L51
        L35:
            android.accounts.Account r3 = new android.accounts.Account     // Catch: java.lang.Throwable -> L51
            ...
            boolean r3 = r12.moveToNext()     // Catch: java.lang.Throwable -> L51
            if (r3 != 0) goto L35
        L4b:
            if (r12 == 0) goto L50
            r12.close()
