...
public class AccountsDb implements AutoCloseable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Removed duplicated region for block: B:11:0x0054 A[DONT_GENERATE] */
    /*
    ...
    */
    public java.util.List<android.accounts.Account> getSharedAccounts() {
        /*
            ...
            r1 = 0
            r10 = r1
            java.lang.String r2 = "shared_accounts"
            java.lang.String r1 = "name"
            java.lang.String r3 = "type"
            java.lang.String[] r3 = new java.lang.String[]{r1, r3}     // Catch: java.lang.Throwable -> L58
            r4 = 0
            r5 = 0
            r6 = 0
            r7 = 0
        ...
        L3c:
            android.accounts.Account r3 = new android.accounts.Account     // Catch: java.lang.Throwable -> L58
            java.lang.String r4 = r10.getString(r1)     // Catch: java.lang.Throwable -> L58
            java.lang.String r5 = r10.getString(r2)     // Catch: java.lang.Throwable -> L58
            r3.<init>(r4, r5)     // Catch: java.lang.Throwable -> L58
            r9.add(r3)     // Catch: java.lang.Throwable -> L58
            boolean r3 = r10.moveToNext()     // Catch: java.lang.Throwable -> L58
            if (r3 != 0) goto L3c
        L52:
            if (r10 == 0) goto L57
            r10.close()
    ...
    Account findDeAccountByAccountId(long accountId) {
        SQLiteDatabase db = this.mDeDatabase.getReadableDatabase();
        Cursor cursor = db.query(TABLE_ACCOUNTS, new String[]{"name", "type"}, "_id=? ", new String[]{String.valueOf(accountId)}, null, null, null);
        try {
            if (cursor.moveToNext()) {
    ...
    public int calculateDebugTableInsertionPoint() {
        ...
        return (int) DatabaseUtils.longForQuery(db, queryCountDebugDbRows2, null);
    }
