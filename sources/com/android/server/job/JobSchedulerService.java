...
public class JobSchedulerService extends SystemService implements StateChangedListener, JobCompletedListener {
    ...
    public static class MaxJobCountsPerMemoryTrimLevel {
        ...
        MaxJobCountsPerMemoryTrimLevel(MaxJobCounts normal, MaxJobCounts moderate, MaxJobCounts low, MaxJobCounts critical) {
            this.normal = normal;
                    ...
                    if (pkgName != null && pkgUid != -1) {
                        ...
                        if (changedComponents != null) {
                            ...
                            while (true) {
                                ...
                                String component = changedComponents[c];
    ...
    JobStatus getRescheduleJobForPeriodic(JobStatus periodicToReschedule) {
        ...
        if (elapsedNow > latestRunTimeElapsed) {
            ...
            if (period != flex && diffMs > Math.min(1800000L, (period - flex) / 2)) {
                if (DEBUG) {
            ...
            if (diffMs < 1800000 && diffMs < period / 6) {
                long newLatestRuntimeElapsed2 = (period / 6) - diffMs;
                rescheduleBuffer = Math.min(1800000L, newLatestRuntimeElapsed2);
                ...
                if (JobSchedulerService.this.mReadyToRock) {
                    ...
                    switch (message.what) {
                        ...
                        case 5:
                            ...
                            JobSchedulerService.this.updateUidState(uid2, 20);
                            if (disabled) {
    ...
    void advanceHeartbeatLocked(long beatsElapsed) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                jArr2[i] = jArr2[i] + this.mConstants.STANDBY_BEATS[i];
            }
            if (DEBUG_STANDBY) {
            ...
            if (!this.mInParole && !job.uidActive && !job.getJob().isExemptedFromAppStandby()) {
                ...
                if (this.mHeartbeat < this.mNextBucketHeartbeat[bucket]) {
                    ...
                    if (bucket < this.mConstants.STANDBY_BEATS.length) {
                        long j = this.mHeartbeat;
                        if (j <= appLastRan || j >= this.mConstants.STANDBY_BEATS[bucket] + appLastRan) {
                            if (DEBUG_STANDBY) {
        ...
        public List<JobInfo> getSystemScheduledPendingJobs() {
            ...
            synchronized (JobSchedulerService.this.mLock) {
                ...
                JobSchedulerService.this.mJobs.forEachJob(1000, new Consumer() { // from class: com.android.server.job.-$$Lambda$JobSchedulerService$LocalService$yaChpLJ2odu2Fk7A6H8erUndrN8
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        JobSchedulerService.LocalService.this.lambda$getSystemScheduledPendingJobs$0$JobSchedulerService$LocalService(pendingJobs, (JobStatus) obj);
                    }
                });
            }
            return pendingJobs;
    ...
    public final class JobSchedulerStub extends IJobScheduler.Stub {
        ...
        public ParceledListSlice<JobSnapshot> getAllJobSnapshots() {
            ...
            synchronized (JobSchedulerService.this.mLock) {
                ...
                JobSchedulerService.this.mJobs.forEachJob(new Consumer() { // from class: com.android.server.job.-$$Lambda$JobSchedulerService$JobSchedulerStub$9zQe5CBU32yn1NEDzLYvt_QAEGk
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        JobSchedulerService.JobSchedulerStub.this.lambda$getAllJobSnapshots$0$JobSchedulerService$JobSchedulerStub(snapshots, (JobStatus) obj);
                    }
                });
    ...
    void dumpInternal(IndentingPrintWriter pw, int filterUid) {
        ...
        int filterUidFinal;
        final int filterUidFinal2 = UserHandle.getAppId(filterUid);
        long now2 = sSystemClock.millis();
        long nowElapsed = sElapsedRealtimeClock.millis();
        long nowUptime = sUptimeMillisClock.millis();
        Predicate<JobStatus> predicate2 = new Predicate() { // from class: com.android.server.job.-$$Lambda$JobSchedulerService$e8zIA2HHN2tnGMuc6TZ2xWw_c20
            @Override // java.util.function.Predicate
            public final boolean test(Object obj2) {
                return JobSchedulerService.lambda$dumpInternal$3(filterUidFinal2, (JobStatus) obj2);
            }
        };
    ...
    void dumpInternalProto(FileDescriptor fd, int filterUid) {
        ...
        long nowElapsed = sElapsedRealtimeClock.millis();
        long nowUptime = sUptimeMillisClock.millis();
        Predicate<JobStatus> predicate2 = new Predicate() { // from class: com.android.server.job.-$$Lambda$JobSchedulerService$rARZcsrvtM2sYbF4SrEE2BXDQ3U
            @Override // java.util.function.Predicate
            public final boolean test(Object obj2) {
                return JobSchedulerService.lambda$dumpInternalProto$4(filterUidFinal2, (JobStatus) obj2);
            }
        };
        Object obj2 = this.mLock;
        synchronized (obj2) {
