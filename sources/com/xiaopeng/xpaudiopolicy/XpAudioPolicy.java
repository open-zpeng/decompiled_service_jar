...
public class XpAudioPolicy {
    ...
    public static final int DEFAULT_VOLUME_MEDIA = FeatureOption.FO_MEDIA_DEFAULT_VOLUME;
    ...
    static {
        isNewMainDriverMode = SystemProperties.getInt("persist.sys.xiaopeng.isnewmaindriver", 1) == 1;
    ...
    public void saveVolume(int type, String prop, int index) {
        if (type == 0) {
            ...
            Settings.System.putInt(this.mContext.getContentResolver(), prop, index);
        }
    }
    ...
    private int getSavedVolume(int type, String prop, int defindex) {
        ...
        return Settings.System.getInt(this.mContext.getContentResolver(), prop, defindex);
    }
    ...
    public void saveMute(int type, String prop, int muted) {
        if (type == 0) {
            ...
            Settings.System.putInt(this.mContext.getContentResolver(), prop, muted);
        }
    }
    ...
    public boolean isAnyStreamActive() {
        if (isFmOn()) {
            ...
            return true;
        } else if (this.mxpAudio == null || !this.mxpAudio.isKaraokeOn()) {
            for (int i = 0; i <= 10; i++) {
    ...
    public int applyStreamType(int streamType) {
        ...
        if (isLegalSoundType(soundType) && this.mXpAmpPolicy != null) {
            this.mLastActiveSoundBits = 0;
            this.mXpAmpPolicy.setAmpChanVolSource(getChannels(soundType), 100, getInterface(soundType), getChannels(soundType));
            return 0;
        }
        return -1;
    }
    ...
    public void setStereoAlarm(boolean enable) {
        ...
        stereoAlarm = enable;
        if (this.mContext != null) {
            Settings.System.putInt(this.mContext.getContentResolver(), "XpStereoAlarmOn", enable ? 1 : 0);
        }
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setStereoAlarm(enable);
        }
    }
    ...
    public void setSpeechSurround(boolean enable) {
        ...
        if (this.mContext != null) {
            Settings.System.putInt(this.mContext.getContentResolver(), "XpSpeechSurroundOn", enable ? 1 : 0);
        }
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setSpeechSurround(enable);
        }
    }
    ...
    public void setMainDriverMode(int mode) {
        ...
        mainDriverMode = mode;
        if (this.mContext != null) {
            Settings.System.putInt(this.mContext.getContentResolver(), "XpMainDriverMode", mode);
        }
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setMainDriverMode(mode);
        }
    ...
    public int getMainDriverMode() {
        if (this.mContext != null) {
            mainDriverMode = Settings.System.getInt(this.mContext.getContentResolver(), "XpMainDriverMode", 0);
        }
    ...
    public void setBtHeadPhone(boolean enable) {
        ...
        btheadphone = enable;
        if (this.mContext != null) {
            Settings.System.putInt(this.mContext.getContentResolver(), "XpBtHeadPhoneOn", enable ? 1 : 0);
        }
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setBtHeadPhone(enable);
        }
        int activeSoundBits = getActiveSoundBits(0, false);
        this.mLastActiveSoundBits = 0;
        changeChannel(activeSoundBits);
    ...
    public void setSoundEffectMode(int mode) {
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setSoundEffectMode(mode);
        }
    }

    public void setSoundEffectType(int mode, int type) {
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setSoundEffectType(mode, type);
        }
    }

    public void setSoundEffectScene(int mode, int scene) {
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setSoundEffectScene(mode, scene);
        }
    }

    public void setSoundField(int mode, int xSound, int ySound) {
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setSoundField(mode, xSound, ySound);
        }
    }

    public boolean isStereoAlarmOn() {
        if (this.mContext != null) {
            stereoAlarm = Settings.System.getInt(this.mContext.getContentResolver(), "XpStereoAlarmOn", 0) == 1;
        }
    ...
    public boolean isSpeechSurroundOn() {
        if (this.mContext != null) {
            speechSurround = Settings.System.getInt(this.mContext.getContentResolver(), "XpSpeechSurroundOn", 0) == 1;
        }
    ...
    public boolean isBtHeadPhoneOn() {
        if (this.mContext != null) {
            btheadphone = Settings.System.getInt(this.mContext.getContentResolver(), "XpBtHeadPhoneOn", 0) == 1;
        }
    ...
    public void igOnResetFlags() {
        ...
        if (this.mHandler != null) {
            Message m = this.mHandler.obtainMessage(3, 0, 0, 0);
    ...
    public boolean releaseAlarmBits(int usage, int id) {
        ...
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setAlarmChannels(getMixedAlarmBits());
        }
    ...
    private void initXpVolumes() {
        ...
        this.mXpVolumes[0] = getSavedVolume(0, PROP_VOLUME_MEDIA, DEFAULT_VOLUME_MEDIA);
    ...
    private void initXpMutes() {
        ...
        this.mXpMutes[0] = false;
        this.mXpMutes[1] = false;
        this.mXpMutes[2] = false;
        this.mXpMutes[3] = false;
        this.mXpMutes[4] = false;
    }
    ...
    public void setBtCallOnFlag(int flag) {
        ...
        if (this.mXpAmpPolicy != null) {
            ...
            } else if (mBtCallFlag == 1) {
                this.mXpAmpPolicy.setBtCallOnFlag(1);
            } else if (mBtCallFlag == 3) {
    ...
    public void setVoicePosition(final int position, final int flag, String pkgName) {
        ...
        } else if (this.mXpAmpPolicy != null && this.isHighAmp) {
            final int currentPosition = this.mXpAmpPolicy.getVoicePosition();
            ...
            new Thread() { // from class: com.xiaopeng.xpaudiopolicy.XpAudioPolicy.11
                ...
                public void run() {
                    ...
                    try {
                        ...
                        while (mediabits <= 10) {
                            int i2 = 3;
                            int mediabits2 = XpAudioPolicy.this.mXpAmpPolicy.getChannels(3);
                            int mixChannelBits = mediabits2 & (srcBit | destBit);
                            int spdifChannelBits = mediabits2 & (~mixChannelBits);
                            int activeChannelBits = mediabits2 | srcBit | destBit;
                            int i3 = (srcBit & mixChannelBits) == 0 ? 0 : i;
                            int i4 = (destBit & mixChannelBits) == 0 ? 0 : i;
                            if (spdifChannelBits != 0) {
                                XpAudioPolicy.this.mXpAmpPolicy.setAmpChanVolSource(spdifChannelBits, 100, i, activeChannelBits);
                            }
                            if (currentPosition != -1) {
                                IXpAmpPolicy iXpAmpPolicy = XpAudioPolicy.this.mXpAmpPolicy;
                                int i5 = 100 - (mediabits * 10);
                                if (i3 == 0) {
                                    i2 = 2;
                                }
                                iXpAmpPolicy.setAmpChanVolSource(srcBit, i5, i2, activeChannelBits);
                            }
                            if (position != -1) {
                                XpAudioPolicy.this.mXpAmpPolicy.setAmpChanVolSource(destBit, mediabits * 10, i4 != 0 ? 3 : 2, activeChannelBits);
                            }
                            Thread.sleep(100L);
                            mediabits++;
                            i = 1;
    ...
    public void setCallingOut(boolean enable) {
        ...
        this.mLastActiveSoundBits = 0;
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setCallingOut(enable);
        }
    }
    ...
    public void setCallingIn(boolean enable) {
        ...
        this.mLastActiveSoundBits = 0;
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setCallingIn(enable);
        }
    }

    public int getVoicePosition() {
        if (this.mXpAmpPolicy != null) {
            return this.mXpAmpPolicy.getVoicePosition();
        }
        return 0;
    }
    ...
    public void openKaraokeModeSysVolume(int usage, boolean close) {
        if (this.mxpAudio == null) {
            return;
        }
        if (!this.mxpAudio.isKaraokeOn() && !close && (usage == 13 || usage == 4)) {
    ...
    public int getActiveSoundBits(int usage, boolean in) {
        ...
        for (int activeSoundBits2 = 0; activeSoundBits2 <= 10; activeSoundBits2++) {
            if (AudioSystem.isStreamActive(activeSoundBits2, 0)) {
                if (XPAUDIO_DEBUG == 1) {
                    Log.d(TAG, "getActiveSoundBits() TYPE:" + activeSoundBits2 + " is active");
                }
                int soundType2 = getSoundTypeByStreamType(activeSoundBits2);
                if (soundType2 != -1) {
        ...
        int activeSoundBits3 = activeSoundBits | 8;
        if (((activeSoundBits3 & 64) == 0 || !in) && (activeSoundBits3 & 32) == 0 && (activeSoundBits3 & 16) == 0) {
            activeSoundBits3 |= 128;
        }
        if ((system_follow_speech || (!in && (usageSoundType == 7 || usageSoundType == 1))) && (activeSoundBits3 & 32) != 0) {
            activeSoundBits3 = activeSoundBits3 & (-129) & (-3);
        }
        if ((activeSoundBits3 & 64) != 0) {
            activeSoundBits3 = activeSoundBits3 & (-3) & (-129);
        }
        if (this.mxpAudio != null && this.mxpAudio.getDangerousTtsStatus() != 0) {
            activeSoundBits3 = 72;
        } else if (this.SpeechTrackOn && mBtCallFlag == 0) {
            activeSoundBits3 = 40;
        }
        Log.d(TAG, "getActiveSoundBits() activeSoundBits:" + activeSoundBits3);
        return activeSoundBits3;
    }

    private int getActiveChannelBits(int activeSoundBits) {
        int activeChannelBits = 0;
        for (int activeChannelBits2 = 1; activeChannelBits2 <= 7; activeChannelBits2++) {
            if (((1 << activeChannelBits2) & activeSoundBits) != 0) {
                activeChannelBits |= getChannels(activeChannelBits2);
                if (XPAUDIO_DEBUG == 1) {
                    Log.d(TAG, "getActiveChannelBits activeSoundBits:" + activeSoundBits + " SoundType i:" + activeChannelBits2 + " activeChannelBits:" + activeChannelBits);
                }
            }
        }
    ...
    private int getSpdifChannelBits(int activeSoundBits) {
        ...
        for (int spdifChannelBits2 = 1; spdifChannelBits2 <= 7; spdifChannelBits2++) {
            if (((1 << spdifChannelBits2) & activeSoundBits) != 0) {
                int soundinterface = getInterface(spdifChannelBits2);
                if (soundinterface == 1) {
                    spdifChannelBits |= getChannels(spdifChannelBits2);
                }
                if (XPAUDIO_DEBUG == 1) {
                    Log.d(TAG, "getSpdifChannelBits activeSoundBits:" + activeSoundBits + " SoundType i:" + spdifChannelBits2 + " interface:" + soundinterface + " spdifChannelBits:" + spdifChannelBits);
                }
            }
        }
    ...
    private int getAnalogChannelBits(int activeSoundBits) {
        ...
        for (int analogChannelBits2 = 1; analogChannelBits2 <= 7; analogChannelBits2++) {
            if (((1 << analogChannelBits2) & activeSoundBits) != 0) {
                int soundinterface = getInterface(analogChannelBits2);
                if (soundinterface == 2) {
                    analogChannelBits |= getChannels(analogChannelBits2);
                }
                if (XPAUDIO_DEBUG == 1) {
                    Log.d(TAG, "getAnalogChannelBits activeSoundBits:" + activeSoundBits + " SoundType i:" + analogChannelBits2 + " interface:" + soundinterface + " analogChannelBits:" + analogChannelBits);
                }
            }
        }
    ...
    private int getMixChannelBits(int activeSoundBits) {
        ...
        for (int mixChannelBits2 = 1; mixChannelBits2 <= 7; mixChannelBits2++) {
            if (((1 << mixChannelBits2) & activeSoundBits) != 0) {
                int soundinterface = getInterface(mixChannelBits2);
                if (soundinterface == 3) {
                    mixChannelBits |= getChannels(mixChannelBits2);
                }
                Log.d(TAG, "getMixChannelBits activeSoundBits:" + activeSoundBits + " SoundType i:" + mixChannelBits2 + " interface:" + soundinterface + " mixChannelBits:" + mixChannelBits);
            }
        }
    ...
    public void forceChangeToAmpChannel(int selectBits, int activeBits, int volume, boolean stop) {
        ...
        if (this.isHighAmp) {
            ...
            if (this.mXpAmpPolicy != null) {
                this.mXpAmpPolicy.setAmpChanVolSource(selectBits, volume, 3, activeBits);
            }
        } else if (stop) {
    ...
    public void setKaraokeOn(boolean on) {
        this.mLastActiveSoundBits = 0;
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setKaraokeOn(on);
        }
    }

    public void setDangerousTtsOn(boolean on) {
        if (this.mXpAmpPolicy != null) {
            this.mXpAmpPolicy.setDangerousTtsOn(on);
            int activeSoundBits = getActiveSoundBits(0, false);
            changeChannel(activeSoundBits);
        }
    }
    ...
    public void setDangerousTtsVolLevel(int level) {
        ...
        if (this.mxpAudio != null && (dangerttsStatus = this.mxpAudio.getDangerousTtsStatus()) != 0) {
    ...
    public int getDangerousTtsVolLevel() {
        ...
        int ttsVolLevel = Settings.System.getInt(this.mContext.getContentResolver(), "DangerousTtsVolLevel", 2);
        return ttsVolLevel;
    }
    ...
    public int trigerVolumePolicy(int usage, int activeSoundBits) {
        switch (getSoundTypeByAttrUsage(usage)) {
            case 4:
