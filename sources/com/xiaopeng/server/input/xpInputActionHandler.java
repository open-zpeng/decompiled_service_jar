...
public class xpInputActionHandler {
    ...
    public static final int FLAG_RLBI = 131072;
    public static final int FLAG_RRBI = 262144;
    public static final int FLAG_STEERING = 65536;
    ...
    public static final String MODE_RLBI = "rlbi";
    public static final String MODE_RRBI = "rrbi";
    public static final String MODE_STEERING = "steering";
    ...
    private InputActionFunction mDispatchEventAction = new InputActionFunction(FUNCTION_DISPATCH_EVENT) { // from class: com.xiaopeng.server.input.xpInputActionHandler.3
        ...
        public boolean apply(Object var1) {
            ...
            xpInputManagerService.ThreadExecutor.execute(new Runnable() { // from class: com.xiaopeng.server.input.xpInputActionHandler.3.1
                @Override // java.lang.Runnable
                public void run() {
                    xpInputManager.sendEvent(keycode, source);
                }
            });
            return super.apply(var1);
        }
    ...
    private InputActionFunction mPlaySoundEffectAction = new InputActionFunction(FUNCTION_PLAY_SOUND_EFFECT) { // from class: com.xiaopeng.server.input.xpInputActionHandler.7
        ...
        public boolean apply(Object var1) {
            final int keycode = xpInputActionHandler.getKeycode(var1);
            xpLogger.i(xpInputActionHandler.TAG, "apply playSoundEffectAction keycode:" + keycode);
            xpInputManagerService.ThreadExecutor.execute(new Runnable() { // from class: com.xiaopeng.server.input.xpInputActionHandler.7.1
                ...
                public void run() {
                    ...
                    int i = keycode;
                    if (i != 4 && i != 1016) {
                        if (i == 1065 || i == 1066 || i == 1076 || i == 1077) {
                            effectType = 13;
                        } else {
                            switch (i) {
                                case 1081:
        ...
        public boolean apply(Object var1) {
            ...
            xpInputActionHandler.this.mHandler.post(new Runnable() { // from class: com.xiaopeng.server.input.xpInputActionHandler.12.1
                ...
                public void run() {
                    ...
                    content.put(xpInputManagerService.InputPolicyKey.KEY_SOURCE, String.valueOf(source));
    ...
    static {
        ...
        sModeMapping.put(MODE_STEERING, 65536);
        sModeMapping.put(MODE_RLBI, 131072);
        sModeMapping.put(MODE_RRBI, 262144);
    ...
    public static void setIcmModeSettings(Context context, int mode) {
        try {
            int rightValue = 1;
            int leftValue = hasFlags(MODE_ILC, mode) ? 1 : 0;
            if (!hasFlags(MODE_IRC, mode)) {
                rightValue = 0;
            }
            ...
            if (leftValue != leftSettings) {
                setSystemInt(context, InputSettingsObserver.KEY_ILC_MODE, leftValue);
            }
            if (rightValue != rightSettings) {
                setSystemInt(context, InputSettingsObserver.KEY_IRC_MODE, rightValue);
            }
            xpLogger.i(TAG, "setIcmModeSettings leftValue=" + leftValue + " rightValue=" + rightValue + " leftSettings=" + leftSettings + " rightSettings=" + rightSettings);
        } catch (Exception e) {
        }
    }
    ...
    public boolean inputValidCheckEnable() {
        return Settings.System.getInt(this.mContext.getContentResolver(), "XpWheelkeyIgnore", 0) != 0;
    }
    ...
    public static final class CarManagerHelper {
        ...
        public static InputSignalInfo makeIcmSignal(int keycode, int mode) {
            ...
            if (keycode == 1004) {
                ...
                boolean acc = xpInputActionHandler.hasFlags(xpInputActionHandler.MODE_ACC, mode);
                boolean lcc = xpInputActionHandler.hasFlags(xpInputActionHandler.MODE_LCC, mode);
                boolean irc = xpInputActionHandler.hasFlags(xpInputActionHandler.MODE_IRC, mode);
                if (acc || lcc) {
                    info.mode = mode;
                    info.signal = createSignalContent("CardModeDeniedAccToast", true);
                } else {
    ...
    public static final class InputIntentManager {
        ...
        public static Intent makeInputIntent(Context context, int keycode, InputEventSettings settings) {
            ...
            } else if (keycode == 1026) {
                intent.setAction(ACTION_XPENG_KEY_USER);
            } else if (keycode == 1090 || keycode == 1092 || keycode == 1094) {
        ...
        public static void sendBroadcastAsUser(Context context, int keycode, InputEventSettings settings) {
            try {
                ...
                if (intent != null) {
                    xpLogger.i(xpInputActionHandler.TAG, "sendBroadcastAsUser intent=" + intent.getAction());
    ...
    public final class InputSettingsObserver extends ContentObserver {
        ...
        private static final String KEY_LEFT_REAR_BOSS_MODE = "left_door_hot_key_sw";
        ...
        private static final String KEY_RIGHT_REAR_BOSS_MODE = "right_door_hot_key_sw";
        ...
        public void init() {
            ...
            xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_RLBI, getSystemInt(KEY_LEFT_REAR_BOSS_MODE, 0) == 1);
            xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_RRBI, getSystemInt(KEY_RIGHT_REAR_BOSS_MODE, 0) == 1);
            xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_MIRROR, getSystemInt(KEY_MIRROR_MODE, 0) == 1);
            xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_STEERING, getSystemInt(KEY_STEERING_MODE, 0) == 1);
        ...
        public void registerObserver(boolean register) {
            ...
            if (register) {
                ...
                resolver.registerContentObserver(getSystemUri(KEY_LEFT_REAR_BOSS_MODE), false, this);
                resolver.registerContentObserver(getSystemUri(KEY_RIGHT_REAR_BOSS_MODE), false, this);
                resolver.registerContentObserver(getSystemUri(KEY_MIRROR_MODE), false, this);
                resolver.registerContentObserver(getSystemUri(KEY_STEERING_MODE), false, this);
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (uri.equals(getSystemUri(KEY_XPENG_KEY_SETTINGS))) {
                ...
                if (uri.equals(getSystemUri(KEY_TRD_MODE))) {
                    ...
                    } else if (uri.equals(getSystemUri(KEY_LEFT_REAR_BOSS_MODE))) {
                        xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_RLBI, getSystemInt(KEY_LEFT_REAR_BOSS_MODE, 0) == 1);
                    } else if (uri.equals(getSystemUri(KEY_RIGHT_REAR_BOSS_MODE))) {
                        xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_RRBI, getSystemInt(KEY_RIGHT_REAR_BOSS_MODE, 0) == 1);
                    } else if (uri.equals(getSystemUri(KEY_MIRROR_MODE))) {
                        xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_MIRROR, getSystemInt(KEY_MIRROR_MODE, 0) == 1);
                    } else if (uri.equals(getSystemUri(KEY_STEERING_MODE))) {
                        xpInputActionHandler.this.setMode(xpInputActionHandler.MODE_STEERING, getSystemInt(KEY_STEERING_MODE, 0) == 1);
