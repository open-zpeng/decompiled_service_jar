...
public class xpPackageManagerService {
    ...
    private static final String XP_PRE_PACKAGES_DIR = "/system/etc/xuiservice/packages/";
    ...
    public void initScreenSize() {
        ...
        if (wm != null) {
            try {
                ...
                Rect displayRect = xpWindowManager.getRealDisplayRect(this.mContext);
                if (appRect != null) {
            ...
            try {
                ...
                for (int i = 0; i < pkgConfig.length(); i++) {
                    ...
                    if (!TextUtils.isEmpty(packageName)) {
                        ...
                        info.multiscreenMode = getIntValue(object, "multiscreenMode");
