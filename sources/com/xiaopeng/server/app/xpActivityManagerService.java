...
public class xpActivityManagerService {
    ...
    public void handleActivityModeChanged(String packageName) {
        ...
        if (this.mInfo != null && info != null && this.mInfo.executeMode == info.executeMode && this.mInfo.navigationKey == info.navigationKey && this.mInfo.requestAudioFocus == info.requestAudioFocus && this.mInfo.appType == info.appType) {
            this.mInfo = info;
            return;
        }
        this.mInfo = info;
