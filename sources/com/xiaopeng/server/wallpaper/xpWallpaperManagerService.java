...
public class xpWallpaperManagerService {
    ...
    private static int sDefaultFgWallpaperId = 17302229;
    private static int sDefaultBgWallpaperId = 17301717;
    ...
    public void attachWallpaper() {
        Rect rect = getDisplayRect(this.mWindowManager);
        if (rect != null) {
            try {
                ...
                xpLogger.i(TAG, "attachWallpaper");
            } catch (Exception e) {
            }
        }
    }
    ...
    public void setWallpaper(final int fgId, final int bgId) {
        if (this.mWallpaperView != null && (this.mWallpaperView instanceof WallpaperView)) {
            this.mWallpaperView.post(new Runnable() { // from class: com.xiaopeng.server.wallpaper.xpWallpaperManagerService.1
