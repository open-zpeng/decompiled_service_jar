    ...
    public static List<JSONObject> createEntryContent(Context context, NetworkStatsEntry entry) {
        ...
        if (entry != null) {
            try {
                ...
                int uid = entry.uid;
                if (uid == -5) {
                    packageName = ConnectivityService.TETHERING_ARG;
                    ...
                    Log.d(TAG, "tethering stats: " + (entry.ethernetRxBytes + entry.ethernetTxBytes));
                } else if (uid == 0) {
                    return null;
                } else {
                    if (uid == 1000) {
                        packageName = "system";
                        HashMap<Integer, NetworkStatsEntry> tags2 = entry.tags;
                        if (tags2 != null && tags2.keySet() != null) {
                            for (Integer num2 : tags2.keySet()) {
                                int tag2 = num2.intValue();
                                JSONObject o2 = new JSONObject();
                                NetworkStatsEntry nse2 = tags2.get(Integer.valueOf(tag2));
                                if (nse2 != null) {
                                    o2.put("APP", nse2.getPackages());
                                    o2.put("Wifi", nse2.wifiRxBytes + nse2.wifiTxBytes);
                                    o2.put("WifiUp", nse2.wifiTxBytes);
                                    o2.put("WifiDown", nse2.wifiRxBytes);
                                    o2.put("Mobile", nse2.ethernetRxBytes + nse2.ethernetTxBytes);
                                    o2.put("MobileUp", nse2.ethernetTxBytes);
                                    o2.put("MobileDown", nse2.ethernetRxBytes);
                                    list.add(o2);
                                }
                            }
                        }
