...
public class NetworkStatsEntry {
    ...
    public void addTagEntry(int _tag, int _uid, long _rxBytes, long _txBytes, long _wifiRxBytes, long _wifiTxBytes, long _ethernetRxBytes, long _ethernetTxBytes) {
        HashMap<Integer, NetworkStatsEntry> hashMap;
        if (_tag > 0 && (hashMap = this.tags) != null) {
            NetworkStatsEntry entry = hashMap.containsKey(Integer.valueOf(_tag)) ? this.tags.get(Integer.valueOf(_tag)) : new NetworkStatsEntry(_uid, 0L, 0L);
            if (entry != null) {
