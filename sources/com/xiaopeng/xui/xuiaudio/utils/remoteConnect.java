...
public class remoteConnect {
    ...
    private static final String SOUND_RESOURCE_SERVICE = "sndresource";
    ...
    private ISoundResource mSoundResource;
    ...
    private final ServiceConnection mMediaServiceConnectionListener = new ServiceConnection() { // from class: com.xiaopeng.xui.xuiaudio.utils.remoteConnect.2
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            try {
                binder2 = remoteConnect.this.mXUIService.getXUIService(remoteConnect.SOUND_RESOURCE_SERVICE);
            } catch (RemoteException e2) {
                remoteConnect.handleException(e2);
            }
            if (binder2 != null) {
                remoteConnect.this.mSoundResource = ISoundResource.Stub.asInterface(binder2);
            }
    ...
    public ISoundResource getSoundResource() {
