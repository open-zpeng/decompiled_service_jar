...
public abstract class AppLaunchEvent implements Parcelable {
    ...
    public static final class IntentStarted extends AppLaunchEvent {
        ...
        public boolean equals(Object other) {
            return (other instanceof IntentStarted) && this.intent.equals(((IntentStarted) other).intent) && super.equals(other);
        }
    ...
    public static abstract class BaseWithActivityRecordData extends AppLaunchEvent {
        ...
        @Override // com.google.android.startop.iorap.AppLaunchEvent
        public boolean equals(Object other) {
            return (other instanceof BaseWithActivityRecordData) && this.activityRecordSnapshot.equals(((BaseWithActivityRecordData) other).activityRecordSnapshot) && super.equals(other);
        }
    ...
    public static class ActivityLaunchCancelled extends AppLaunchEvent {
        ...
        @Override // com.google.android.startop.iorap.AppLaunchEvent
        public boolean equals(Object other) {
            return (other instanceof ActivityLaunchCancelled) && Objects.equals(this.activityRecordSnapshot, ((ActivityLaunchCancelled) other).activityRecordSnapshot) && super.equals(other);
        }
