...
public final class Properties {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            this.supportedIdentifierTypes.add(Integer.valueOf(childBlob.getInt32(_hidl_index_02 * 4)));
        }
        ...
        while (true) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob2, _hidl_index_03 * 32);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_03 >= _hidl_vec_size2) {
                ...
                this.vendorInfo.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 32);
