...
public final class ProgramListChunk {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 120, _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        this.modified.clear();
        int _hidl_index_0 = 0;
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ProgramInfo _hidl_vec_element = new ProgramInfo();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_02 * 120);
            this.modified.add(_hidl_vec_element);
        }
        int _hidl_vec_size2 = _hidl_blob.getInt32(_hidl_offset + 24 + 8);
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 16, _hidl_blob.handle(), 0 + _hidl_offset + 24, true);
        this.removed.clear();
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size2) {
                ...
                _hidl_vec_element2.readEmbeddedFromParcel(parcel, childBlob2, _hidl_index_03 * 16);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            this.modified.get(_hidl_index_02).writeEmbeddedToBlob(childBlob, _hidl_index_02 * 120);
        }
        ...
        while (true) {
            ...
            if (_hidl_index_03 >= _hidl_vec_size2) {
                ...
                this.removed.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 16);
                _hidl_index_0 = _hidl_index_03 + 1;
            }
        }
    }
