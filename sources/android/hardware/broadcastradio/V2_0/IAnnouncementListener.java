...
public interface IAnnouncementListener extends IBase {
    ...
    static IAnnouncementListener asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IAnnouncementListener castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IAnnouncementListener getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IAnnouncementListener getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IAnnouncementListener getService(String serviceName) throws RemoteException {
    ...
    public static final class Proxy implements IAnnouncementListener {
        ...
        @Override // android.hardware.broadcastradio.V2_0.IAnnouncementListener, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    ArrayList<Announcement> announcements = Announcement.readVectorFromParcel(_hidl_request);
                    onListUpdated(announcements);
                    return;
                case 256067662:
