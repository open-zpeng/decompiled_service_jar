...
public interface ITunerSession extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ITunerSession {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    int _hidl_out_result = _hidl_flags & 1;
                    if (_hidl_out_result != 0) {
                    ...
                    int _hidl_out_result2 = tune(program);
                ...
                case 5:
                    ...
                    int _hidl_out_result5 = startProgramListUpdates(filter);
                    _hidl_reply.writeStatus(0);
                ...
                case 6:
                    ...
                    return;
                case 7:
                    int _hidl_out_result6 = _hidl_flags & 1;
                    if (_hidl_out_result6 != 0) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    }
