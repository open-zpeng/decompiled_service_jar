...
public final class ProgramFilter {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            this.identifierTypes.add(Integer.valueOf(childBlob.getInt32(_hidl_index_02 * 4)));
        }
        int _hidl_vec_size2 = _hidl_blob.getInt32(_hidl_offset + 16 + 8);
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 16, _hidl_blob.handle(), _hidl_offset + 16 + 0, true);
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size2) {
                ...
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob2, _hidl_index_03 * 16);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            this.identifiers.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 16);
