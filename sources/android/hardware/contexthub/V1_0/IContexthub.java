...
public interface IContexthub extends IBase {
    ...
    public static final class Proxy implements IContexthub {
        ...
        @Override // android.hardware.contexthub.V1_0.IContexthub, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 7:
                    ...
                    _hidl_is_oneway = _hidl_out_result6 != 0;
                    if (_hidl_is_oneway) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    ...
                    int _hidl_out_result7 = disableNanoApp(hubId6, appId3, transactionId4);
                    _hidl_reply.writeStatus(0);
                ...
                case 8:
                    ...
                    int _hidl_out_result8 = queryApps(hubId7);
                    _hidl_reply.writeStatus(0);
