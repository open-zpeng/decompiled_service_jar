...
public interface IContexthubCallback extends IBase {
    ...
    public static final class Proxy implements IContexthubCallback {
        ...
        @Override // android.hardware.contexthub.V1_0.IContexthubCallback, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IContexthubCallback {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    int result = _hidl_flags & 1;
                    _hidl_is_oneway = result != 0;
                    if (_hidl_is_oneway) {
