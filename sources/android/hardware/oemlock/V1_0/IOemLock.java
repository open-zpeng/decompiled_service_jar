...
public interface IOemLock extends IBase {
    ...
    public static final class Proxy implements IOemLock {
        ...
        @Override // android.hardware.oemlock.V1_0.IOemLock, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    _hidl_index_0 = _hidl_out_status2 != 0 ? 1 : 0;
                    if (_hidl_index_0 != 0) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                ...
                case 4:
                    ...
                    int _hidl_out_status3 = setOemUnlockAllowedByDevice(allowed2);
                    _hidl_reply.writeStatus(0);
