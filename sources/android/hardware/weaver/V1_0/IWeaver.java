...
public interface IWeaver extends IBase {
    ...
    public static final class Proxy implements IWeaver {
        ...
        @Override // android.hardware.weaver.V1_0.IWeaver, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IWeaver {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-101, -60, 52, 19, -72, 12, -48, -59, -102, 2, 46, -109, -38, 20, 72, -36, -72, 45, -47, 12, 109, -45, 25, 50, -33, 70, 89, -28, -67, -53, 19, 104}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
