...
public interface IHealth extends IBase {
    ...
    public static final class Proxy implements IHealth {
        ...
        @Override // android.hardware.health.V1_0.IHealth, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IHealth {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-111, -30, -70, 56, 5, -55, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -16, 31, -63, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, 30, -55, -1, UsbASFormat.EXT_FORMAT_TYPE_III, -119, 66, -82, -29, 52, 111, 45, 118, 20, -20, -64, -54, -22, -37, -27, 126, -44}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    update(info, new updateCallback() { // from class: android.hardware.health.V1_0.IHealth.Stub.1
                ...
                case 3:
                    ...
                    _hidl_request.enforceInterface(IHealth.kInterfaceName);
                    energyCounter(new energyCounterCallback() { // from class: android.hardware.health.V1_0.IHealth.Stub.2
