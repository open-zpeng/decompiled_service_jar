...
public interface IHealth extends IBase {
    ...
    public static final class Proxy implements IHealth {
        ...
        @Override // android.hardware.health.V2_0.IHealth, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IHealth {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{103, 86, UsbASFormat.EXT_FORMAT_TYPE_II, -35, UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, 7, Byte.MIN_VALUE, 92, -104, 94, -86, -20, -111, 97, UsbDescriptor.DESCRIPTORTYPE_SUPERSPEED_HUB, -68, -120, -12, -62, 91, 52, 49, -5, -124, 7, 11, 117, -124, -95, -89, 65, -5}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_is_oneway = _hidl_out_result != 0;
                    if (_hidl_is_oneway) {
                    ...
                    int _hidl_out_result2 = registerCallback(callback);
                ...
                case 2:
                    ...
                    int _hidl_out_result3 = unregisterCallback(callback2);
                    _hidl_reply.writeStatus(0);
