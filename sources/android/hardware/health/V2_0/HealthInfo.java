...
public final class HealthInfo {
    ...
    public static final ArrayList<HealthInfo> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE, _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            HealthInfo _hidl_vec_element = new HealthInfo();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE, _hidl_blob.handle(), _hidl_offset + 80 + 0, true);
        ...
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 48, _hidl_blob.handle(), _hidl_offset + 96 + 0, true);
    ...
    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob((int) HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HealthInfo> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.diskStats.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * HdmiCecKeycode.UI_BROADCAST_DIGITAL_CABLE);
        }
