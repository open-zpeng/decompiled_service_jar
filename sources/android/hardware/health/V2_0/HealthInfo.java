...
public final class HealthInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(_hidl_vec_size * 112, _hidl_blob.handle(), _hidl_offset + 80 + 0, true);
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_02 * 112);
            this.diskStats.add(_hidl_vec_element);
        }
        int _hidl_vec_size2 = _hidl_blob.getInt32(_hidl_offset + 96 + 8);
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 48, _hidl_blob.handle(), 0 + _hidl_offset + 96, true);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size2) {
                this.storageInfos.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 48);
