...
public final class GadgetFunction {
    ...
    public static final String toString(long o) {
        ...
        if (o == 4) {
            return UsbProfileGroupSettingsManager.UNSUPPORT_IFACE_MTP;
        }
        if (o == 8) {
            return "MIDI";
        }
        if (o == 16) {
            return UsbProfileGroupSettingsManager.UNSUPPORT_IFACE_PTP;
        }
        if (o == 32) {
            return "RNDIS";
        }
    ...
    public static final String dumpBitfield(long o) {
        ...
        if ((o & 4) == 4) {
            list.add(UsbProfileGroupSettingsManager.UNSUPPORT_IFACE_MTP);
            flipped |= 4;
        }
        if ((o & 8) == 8) {
            list.add("MIDI");
        ...
        if ((o & 16) == 16) {
            list.add(UsbProfileGroupSettingsManager.UNSUPPORT_IFACE_PTP);
            flipped |= 16;
        }
        if ((o & 32) == 32) {
            list.add("RNDIS");
