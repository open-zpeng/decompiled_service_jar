...
public interface IUsbCallback extends android.hardware.usb.V1_1.IUsbCallback {
    ...
    public static final class Proxy implements IUsbCallback {
        ...
        public void notifyPortStatusChange(ArrayList<android.hardware.usb.V1_0.PortStatus> currentPortStatus, int retval) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.usb.V1_0.IUsbCallback.kInterfaceName);
            android.hardware.usb.V1_0.PortStatus.writeVectorToParcel(_hidl_request, currentPortStatus);
    ...
    public static abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                ArrayList<android.hardware.usb.V1_0.PortStatus> currentPortStatus = android.hardware.usb.V1_0.PortStatus.readVectorFromParcel(_hidl_request);
                int retval = _hidl_request.readInt32();
                notifyPortStatusChange(currentPortStatus, retval);
                ...
                notifyRoleSwitchStatus(portName, newRole, retval2);
                ...
                notifyPortStatusChange_1_1(currentPortStatus2, retval3);
                ...
                ArrayList<PortStatus> currentPortStatus3 = PortStatus.readVectorFromParcel(_hidl_request);
                int retval4 = _hidl_request.readInt32();
                notifyPortStatusChange_1_2(currentPortStatus3, retval4);
            } else {
                switch (_hidl_code) {
                    case 256067662:
                        if ((_hidl_flags & 1) != 0) {
