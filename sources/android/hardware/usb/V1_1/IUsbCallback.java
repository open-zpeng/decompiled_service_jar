...
public interface IUsbCallback extends android.hardware.usb.V1_0.IUsbCallback {
    ...
    @Override // android.hardware.usb.V1_0.IUsbCallback, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    IHwBinder asBinder();
    ...
    public static final class Proxy implements IUsbCallback {
        ...
        @Override // android.hardware.usb.V1_1.IUsbCallback, android.hardware.usb.V1_0.IUsbCallback, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{19, -91, Byte.MIN_VALUE, -29, 90, -16, 18, 112, -95, -23, 119, 65, 119, -59, 29, -75, 29, -122, 114, -26, 19, -101, -96, 8, 81, -26, 84, -26, -118, 77, 125, -1}, new byte[]{75, -25, -120, 30, 65, 27, -92, 39, -124, -65, 91, 115, 84, -63, 74, -32, -49, 22, UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, 4, -45, -108, 51, -86, -20, -86, -80, -47, -98, -87, -109, 84}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    int retval = _hidl_flags & 1;
                    _hidl_index_0 = retval != 0 ? 1 : 0;
                    if (_hidl_index_0 != 1) {
                    ...
                    ArrayList<PortStatus> currentPortStatus = PortStatus.readVectorFromParcel(_hidl_request);
                    int retval2 = _hidl_request.readInt32();
                    notifyPortStatusChange(currentPortStatus, retval2);
                    return;
                case 2:
                    ...
                    int retval3 = _hidl_request.readInt32();
                    notifyRoleSwitchStatus(portName, newRole, retval3);
                    return;
                case 3:
                    _hidl_index_0 = (_hidl_flags & 1) != 0 ? 1 : 0;
                    if (_hidl_index_0 != 1) {
                    ...
                    ArrayList<PortStatus_1_1> currentPortStatus2 = PortStatus_1_1.readVectorFromParcel(_hidl_request);
                    int retval4 = _hidl_request.readInt32();
                    notifyPortStatusChange_1_1(currentPortStatus2, retval4);
                    return;
                case 256067662:
