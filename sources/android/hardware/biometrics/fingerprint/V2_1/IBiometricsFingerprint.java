...
public interface IBiometricsFingerprint extends IBase {
    ...
    public static final class Proxy implements IBiometricsFingerprint {
        ...
        @Override // android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    int fid = _hidl_flags & 1;
                    _hidl_is_oneway = fid != 0;
                    if (_hidl_is_oneway) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                ...
                case 8:
                    ...
                    int fid2 = _hidl_request.readInt32();
                    int _hidl_out_debugErrno5 = remove(gid2, fid2);
                    _hidl_reply.writeStatus(0);
