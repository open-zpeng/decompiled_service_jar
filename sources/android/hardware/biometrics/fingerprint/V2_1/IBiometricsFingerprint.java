        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    int timeoutSec2 = _hidl_request.readInt32();
                    int _hidl_out_debugErrno = enroll(hat, gid, timeoutSec2);
                    _hidl_reply.writeStatus(0);
                ...
                case 6:
                    ...
                    return;
                case 7:
                    int _hidl_out_debugErrno4 = _hidl_flags & 1;
                    if (_hidl_out_debugErrno4 != 0) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    }
                    _hidl_request.enforceInterface(IBiometricsFingerprint.kInterfaceName);
                    int _hidl_out_debugErrno5 = enumerate();
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno5);
                    _hidl_reply.send();
                    return;
                case 8:
                    int _hidl_out_debugErrno6 = _hidl_flags & 1;
                    if (_hidl_out_debugErrno6 != 0) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    }
                    ...
                    int _hidl_out_debugErrno7 = remove(gid2, fid);
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_debugErrno7);
                    _hidl_reply.send();
                    return;
                case 9:
                    int gid3 = _hidl_flags & 1;
                    if (gid3 != 0) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    ...
                    int _hidl_out_debugErrno8 = setActiveGroup(gid4, storePath);
                    _hidl_reply.writeStatus(0);
                ...
                case 10:
                    ...
                    int gid5 = _hidl_request.readInt32();
                    int _hidl_out_debugErrno9 = authenticate(operationId, gid5);
                    _hidl_reply.writeStatus(0);
