...
public interface IBiometricsFingerprintClientCallback extends IBase {
    ...
    public static final class Proxy implements IBiometricsFingerprintClientCallback {
        ...
        @Override // android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback, android.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-86, -69, 92, 60, 88, 85, -110, -41, 30, -27, 123, 119, UsbDescriptor.DESCRIPTORTYPE_HUB, -116, 20, -103, 61, 119, -111, 77, -34, -86, 100, -78, -59, UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, -102, 96, 43, 2, -22, 71}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
