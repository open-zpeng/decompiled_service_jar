...
public interface IVibrator extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{6, -22, 100, -52, 53, 101, 119, Byte.MAX_VALUE, 59, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, -98, 64, UsbDescriptor.DESCRIPTORTYPE_BOS, -6, 113, 0, -48, Byte.MAX_VALUE, 56, 39, -83, -109, 87, -80, -59, -45, -58, 81, 56, 78, 85, 83}, new byte[]{-67, -38, -74, 24, 77, 122, 52, 109, -90, -96, 125, -64, UsbASFormat.EXT_FORMAT_TYPE_II, -116, -15, -102, 105, 111, 76, -86, 54, 17, -59, 31, 46, 20, 86, 90, 20, -76, UsbDescriptor.DESCRIPTORTYPE_BOS, -39}));
        }
