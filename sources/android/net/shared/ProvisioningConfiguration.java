...
public class ProvisioningConfiguration {
    ...
    public ProvisioningConfiguration(ProvisioningConfiguration other) {
        ...
        StaticIpConfiguration staticIpConfiguration = other.mStaticIpConfig;
        this.mStaticIpConfig = staticIpConfiguration != null ? new StaticIpConfiguration(staticIpConfiguration) : null;
    ...
    public ProvisioningConfigurationParcelable toStableParcelable() {
        ...
        StaticIpConfiguration staticIpConfiguration = this.mStaticIpConfig;
        p.staticIpConfig = staticIpConfiguration != null ? new StaticIpConfiguration(staticIpConfiguration) : null;
