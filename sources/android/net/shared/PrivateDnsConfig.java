...
public class PrivateDnsConfig {
    ...
    public static PrivateDnsConfig fromParcel(PrivateDnsConfigParcel parcel) {
        ...
        return new PrivateDnsConfig(parcel.hostname, (InetAddress[]) ParcelableUtil.fromParcelableArray(parcel.ips, $$Lambda$SYWvjOUPlAZ_O2Z6yfFU9np1858.INSTANCE).toArray(ips));
    }
}
