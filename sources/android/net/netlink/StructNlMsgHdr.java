...
public class StructNlMsgHdr {
    ...
    public String toString() {
        String typeStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.nlmsg_type) + "(" + NetlinkConstants.stringForNlMsgType(this.nlmsg_type) + ")";
        String flagsStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.nlmsg_flags) + "(" + stringForNlMsgFlags(this.nlmsg_flags) + ")";
        return "StructNlMsgHdr{ nlmsg_len{" + this.nlmsg_len + "}, nlmsg_type{" + typeStr + "}, nlmsg_flags{" + flagsStr + ")}, nlmsg_seq{" + this.nlmsg_seq + "}, nlmsg_pid{" + this.nlmsg_pid + "} }";
    }
}
