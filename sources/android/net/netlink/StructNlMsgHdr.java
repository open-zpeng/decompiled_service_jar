...
public class StructNlMsgHdr {
    ...
    public String toString() {
        String typeStr = "" + ((int) this.nlmsg_type) + "(" + NetlinkConstants.stringForNlMsgType(this.nlmsg_type) + ")";
        String flagsStr = "" + ((int) this.nlmsg_flags) + "(" + stringForNlMsgFlags(this.nlmsg_flags) + ")";
