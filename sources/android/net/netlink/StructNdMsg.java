...
public class StructNdMsg {
    ...
    public String toString() {
        String stateStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.ndm_state) + " (" + stringForNudState(this.ndm_state) + ")";
        String flagsStr = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS + ((int) this.ndm_flags) + " (" + stringForNudFlags(this.ndm_flags) + ")";
